...
- an existing OpenFGA Store configured with a Authorization Model compatible with the tuples being generated
...
```
mvn gatling:test -Dgatling.simulationClass=io.gravitee.am.performance.authorization.OpenFGAProvision -Dfga_store_id=01KEF6BXPQRWWRPT4PPTEKGFZG -Dfga_authorization_model_id=01KEF6BXQ75N96AJJZ0SJ85EJT -Dfga_api_url=http://localhost:8090
```
