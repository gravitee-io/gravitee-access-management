...
object SimulationSettings {
  ...
  val NUMBER_OF_RESOURCES_PER_USER = Integer.getInteger("number_of_resources_per_user", 3)
  val NUMBER_OF_RESOURCES_PER_TEAM = Integer.getInteger("number_of_resources_per_team", 8)
  val NUMBER_OF_SHARED_RESOURCES = Integer.getInteger("number_of_shared_resources", 50)
