 ...
 */
class CreateDomainWithMockMFA extends Simulation {

  val httpProtocol = http
    .userAgentHeader("Gatling - Create Domain with MFA")
    .disableFollowRedirect

  val scn = scenario("Create Domain With MFA")
    .exec(login)
