...
public class JWTBearerExtensionGrantProviderTest {
    ...
    public void must_grant_with_new_processor_rsa256_ssh_key() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.RS256);
    ...
    public void must_grant_with_new_processor_rsa384_ssh_key() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.RS384);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(RSA_SHA384_KEY);
    ...
    public void must_grant_with_new_processor_rsa512_ssh_key() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.RS512);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(RSA_SHA512_KEY);
    ...
    public void must_grant_with_new_processor_ecdsa256_ssh_key() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.ES256);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(ECDSA_SHA2_NISTP_256);
    ...
    public void must_grant_with_new_processor_ecdsa384_ssh_key() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.ES384);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(ECDSA_SHA2_NISTP_384);
    ...
    public void must_grant_with_new_processor_ecdsa512_ssh_key() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.ES512);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(ECDSA_SHA2_NISTP_512);
    ...
    public void must_grant_with_new_processor_hmac256() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.HS256);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
    ...
    public void must_grant_with_new_processor_hmac384() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.HS384);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
    ...
    public void must_grant_with_new_processor_hmac512() throws Exception {
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.HS512);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
    ...
    /**
     * Test fails when using the wrong key type-RSA key with ECDSA algorithm
     */
    @Test
    public void must_fail_with_new_processor_wrong_key_type_rsa_with_ecdsa(){
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.ES256);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(RSA_SHA256_KEY);
        ...
        assertThrows(IllegalArgumentException.class, () -> jwtBearerExtensionGrantProvider.afterPropertiesSet());
    }

    /**
     * Test fails when using the wrong key type-ECDSA key with RSA algorithm
     */
    @Test
    public void must_fail_with_new_processor_wrong_key_type_ecdsa_with_rsa(){
        when(jwtBearerTokenGranterConfiguration.getSignature()).thenReturn(JWTBearerExtensionGrantConfiguration.Signature.RS256);
        when(jwtBearerTokenGranterConfiguration.getPublicKeyResolver()).thenReturn(JWTBearerExtensionGrantConfiguration.KeyResolver.GIVEN_KEY);
        when(jwtBearerTokenGranterConfiguration.getPublicKey()).thenReturn(ECDSA_SHA2_NISTP_256);
