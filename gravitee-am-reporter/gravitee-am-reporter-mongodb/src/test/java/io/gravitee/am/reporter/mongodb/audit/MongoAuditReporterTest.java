...
public class MongoAuditReporterTest {
    ...
    public void init() throws Exception {
        auditReporter = new MongoAuditReporter();
        ...
        // wait for the index initialization
        try {
            Thread.sleep(1000);
    ...
    protected void waitBulkLoadFlush() {
        try {
            Thread.sleep(3000); // bulk load flush interval set to 1s
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
    }
