...
public final class ReactorNetty {
    ...
    static final AttributeKey<Boolean> PERSISTENT_CHANNEL = AttributeKey.newInstance("$PERSISTENT_CHANNEL_REPORTER");

    static final AttributeKey<Connection> CONNECTION = AttributeKey.newInstance("$CONNECTION_REPORTER");
