 ...
 */
@Import(SalesForceAuthenticationProviderConfiguration.class)
public class SalesForceAuthenticationProvider extends AbstractOpenIDConnectAuthenticationProvider {

    @Autowired
    @Qualifier("salesForceWebClient")
    ...
    public void afterPropertiesSet() throws Exception {
        SalesForceIdentityProviderConfiguration configuration = this.configuration;
