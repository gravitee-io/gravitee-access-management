 ...
 */
package io.gravitee.am.identityprovider.salesforce.authentication;
...
import static io.gravitee.am.identityprovider.salesforce.SalesForceIdentityProviderConfiguration.*;
...
public class SalesForceAuthenticationProviderTest {
    ...
    @Spy
    private SalesForceIdentityProviderConfiguration configuration = new SalesForceIdentityProviderConfiguration();
  ...
  "family_name": "Doe"
    ...
    public void shouldGenerateSignInUrl() throws Exception {
        ...
        assertEquals(HOST_LOGIN  + AUTHORIZATION_PATH +"?client_id=testClientId&response_type=code&scope=openid profile email&state=" + state + "&redirect_uri=https://gravitee.io", request.getUri());
    ...
    public void shouldAuthenticate() throws Exception {
        ...
        parameters.set(SalesForceIdentityProviderConfiguration.CODE_PARAMETER, "code");
        ...
        verify(client, times(1)).postAbs(HOST_LOGIN + TOKEN_PATH);
    }
