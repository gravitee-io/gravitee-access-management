...
public class JdbcAuthenticationProviderConfigurationTest implements InitializingBean {
    ...
    private static final String DEFAULT_JDBC_TYPE = "postgresql-tc~17.2";
    ...
    public String url() {
        ...
        if (jdbcType.startsWith("mysql-tc")) {
            return "r2dbc:tc:mysql:///databasename?TC_IMAGE_TAG=" + version("8.0.27");
        }
        if (jdbcType.startsWith("mariadb-tc")) {
            return "r2dbc:tc:mariadb:///databasename?TC_IMAGE_TAG=" + version("10.6.5");
        }
        return "r2dbc:tc:postgresql:///databasename?TC_IMAGE_TAG=" + version("15.1");
    }
