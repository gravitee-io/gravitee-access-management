...
public class JdbcAuthenticationProviderConfigurationTest {

    @Mock
    private JdbcIdentityProviderConfiguration configuration;

    @InjectMocks
    private JdbcAuthenticationProviderConfiguration jdbcAuthenticationProviderConfiguration;

    @Test
    public void shouldUsePasswordEncoder_noConfiguration() {
        when(configuration.getPasswordEncoder()).thenReturn(null);
        var passwordEncoder = jdbcAuthenticationProviderConfiguration.passwordEncoder();
