...
public class AzureADAuthenticationProviderTest {


    private final String TEST_TENANT_ID = "testTenantId";
  ...
  "family_name": "Doe"
    ...
    public void shouldAuthenticate() throws Exception {
        ...
        parameters.set(AzureADIdentityProviderConfiguration.CODE_PARAMETER, "code");
