...
public interface ConstantKeys {
    ...
    String TEMPLATE_KEY_ALLOW_MAGIC_LINK_CONTEXT_KEY = "allowMagicLink";
    ...
    String TEMPLATE_KEY_MAGIC_LINK_ACTION_KEY = "magicLinkAction";
    ...
    String POLICY_CHAIN_ERROR_KEY_INTERNAL_ERROR = "GATEWAY_POLICY_INTERNAL_ERROR";
