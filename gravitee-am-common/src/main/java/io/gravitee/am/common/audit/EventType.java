...
public interface EventType {
    ...
    static Collection<String> types() {
        return new TreeSet<>(Arrays.asList(
                ...
                USER_LOGIN, USER_WEBAUTHN_LOGIN, USER_CBA_LOGIN, USER_MAGIC_LINK_LOGIN, USER_LOGOUT, USER_CREATED, USER_UPDATED, USER_DELETED, USER_LOCKED, USER_UNLOCKED, USER_ENABLED, USER_DISABLED, USER_PASSWORD_RESET, USER_REGISTERED, USER_CONSENT_CONSENTED, USER_CONSENT_REVOKED, USER_ROLES_ASSIGNED,
                REGISTRATION_CONFIRMATION, REGISTRATION_VERIFY_ACCOUNT, REGISTRATION_CONFIRMATION_REQUESTED, REGISTRATION_CONFIRMATION_EMAIL_SENT, REGISTRATION_VERIFY_REQUESTED, REGISTRATION_VERIFY_EMAIL_SENT, FORGOT_PASSWORD_REQUESTED, MAGIC_LINK_REQUESTED,
                FORGOT_PASSWORD_EMAIL_SENT, RESET_PASSWORD_EMAIL_SENT, BLOCKED_ACCOUNT_EMAIL_SENT, MAGIC_LINK_EMAIL_SENT,
                ...
                AUTHORIZATION_ENGINE_CREATED, AUTHORIZATION_ENGINE_UPDATED, AUTHORIZATION_ENGINE_DELETED,
