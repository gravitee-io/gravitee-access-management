    ...
    static Collection<String> types() {
        return new TreeSet(
            Arrays.asList(
                ...
                APPLICATION_UPDATED,
                APPLICATION_DELETED,
                APPLICATION_CLIENT_SECRET_RENEWED,
                USER_LOGIN,
                USER_LOGOUT,
                USER_CREATED,
                USER_UPDATED,
                ...
                USER_PASSWORD_RESET,
                USER_REGISTERED,
                USER_CONSENT_CONSENTED,
                USER_CONSENT_REVOKED,
                USER_ROLES_ASSIGNED,
                REGISTRATION_CONFIRMATION,
                REGISTRATION_CONFIRMATION_REQUESTED,
                ...
                EXTENSION_GRANT_CREATED,
                EXTENSION_GRANT_UPDATED,
                EXTENSION_GRANT_DELETED,
                GROUP_CREATED,
                GROUP_UPDATED,
                GROUP_DELETED,
                GROUP_ROLES_ASSIGNED,
