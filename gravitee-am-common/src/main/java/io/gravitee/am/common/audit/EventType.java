...
public interface EventType {
    ...
    /**
     * ----------
     * Token Exchange (RFC 8693) audit log actions
     * ----------
     */
    String TOKEN_EXCHANGE = "TOKEN_EXCHANGE";
    String TOKEN_EXCHANGE_DELEGATION = "TOKEN_EXCHANGE_DELEGATION";
    String TOKEN_EXCHANGE_IMPERSONATION = "TOKEN_EXCHANGE_IMPERSONATION";
    String TOKEN_EXCHANGE_FAILED = "TOKEN_EXCHANGE_FAILED";
    ...
    static Collection<String> types() {
        return new TreeSet<>(Arrays.asList(
                ...
                USER_LOGIN, USER_WEBAUTHN_LOGIN, USER_CBA_LOGIN, USER_LOGOUT, USER_CREATED, USER_UPDATED, USER_DELETED, USER_LOCKED, USER_UNLOCKED, USER_ENABLED, USER_DISABLED, USER_PASSWORD_RESET, USER_REGISTERED, USER_CONSENT_CONSENTED, USER_CONSENT_REVOKED, USER_ROLES_ASSIGNED,
                ...
                TOKEN_EXCHANGE, TOKEN_EXCHANGE_DELEGATION, TOKEN_EXCHANGE_IMPERSONATION, TOKEN_EXCHANGE_FAILED,
