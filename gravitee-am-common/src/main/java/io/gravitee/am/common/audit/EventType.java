...
public interface EventType {
    ...
    String USER_PASSWORD_VALIDATION = "USER_PASSWORD_VALIDATION";
    ...
    static Collection<String> types() {
        return new TreeSet<>(Arrays.asList(
                ...
                USER_LOGIN, USER_WEBAUTHN_LOGIN, USER_LOGOUT, USER_CREATED, USER_UPDATED, USER_DELETED, USER_LOCKED, USER_UNLOCKED, USER_ENABLED, USER_DISABLED, USER_PASSWORD_RESET, USER_PASSWORD_VALIDATION, USER_REGISTERED, USER_CONSENT_CONSENTED, USER_CONSENT_REVOKED, USER_ROLES_ASSIGNED,
