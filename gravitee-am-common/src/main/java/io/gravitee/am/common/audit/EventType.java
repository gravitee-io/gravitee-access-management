...
public interface EventType {
    ...
    String USER_WEBAUTHN_BROWSER_CLIENT_ERROR = "USER_WEBAUTHN_BROWSER_CLIENT_ERROR";
    ...
    String USER_PREFERENCES_UPDATED = "USER_PREFERENCES_UPDATED";
    ...
    String MAGIC_LINK_REQUESTED = "MAGIC_LINK_REQUESTED";
    String MAGIC_LINK_EMAIL_SENT = "MAGIC_LINK_EMAIL_SENT";
    String VERIFY_ATTEMPT_EMAIL_SENT = "VERIFY_ATTEMPT_EMAIL_SENT";
    ...
    String PROTECTED_RESOURCE_CLIENT_SECRET_RENEWED = "PROTECTED_RESOURCE_CLIENT_SECRET_RENEWED";
    String PROTECTED_RESOURCE_CLIENT_SECRET_CREATED = "PROTECTED_RESOURCE_CLIENT_SECRET_CREATED";
    String PROTECTED_RESOURCE_CLIENT_SECRET_DELETED = "PROTECTED_RESOURCE_CLIENT_SECRET_DELETED";
    ...
    /**
     * ----------
     * Authorization engine audit log actions
     * ----------
     */
    String AUTHORIZATION_ENGINE_CREATED = "AUTHORIZATION_ENGINE_CREATED";
    String AUTHORIZATION_ENGINE_UPDATED = "AUTHORIZATION_ENGINE_UPDATED";
    String AUTHORIZATION_ENGINE_DELETED = "AUTHORIZATION_ENGINE_DELETED";
    ...
    String ORGANIZATION_LICENSE_CREATED = "ORGANIZATION_LICENSE_CREATED";
    String ORGANIZATION_LICENSE_UPDATED = "ORGANIZATION_LICENSE_UPDATED";
    String ORGANIZATION_LICENSE_DELETED = "ORGANIZATION_LICENSE_DELETED";
    ...
    String TRUST_DOMAIN_CREATED = "TRUST_DOMAIN_CREATED";
    String TRUST_DOMAIN_UPDATED = "TRUST_DOMAIN_UPDATED";
    String TRUST_DOMAIN_DELETED = "TRUST_DOMAIN_DELETED";
    ...
    String TOKEN_REVOKE_SCHEDULED = "TOKEN_REVOKE_SCHEDULED";
    ...
    String PERMISSION_EVALUATED = "PERMISSION_EVALUATED";

    static Collection<String> types() {
        return new TreeSet<>(DeclaredTypes.VALUES);
    }
    ...
    final class DeclaredTypes {
        ...
        // a constant's name is not always its value: MFA_VERIFICATION_LIMIT_EXCEED holds MFA_VERIFY_LIMIT_EXCEED
        private static final Set<String> VALUES = Arrays.stream(EventType.class.getDeclaredFields())
                .filter(field -> Modifier.isStatic(field.getModifiers()) && field.getType() == String.class)
                .map(DeclaredTypes::valueOf)
        ...
        private static String valueOf(Field field) {
            try {
                ...
                throw new IllegalStateException("Unable to read audit event type " + field.getName(), e);
            }
        }
    }
}
