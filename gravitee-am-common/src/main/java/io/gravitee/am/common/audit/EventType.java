...
public interface EventType {
    ...
    static Collection<String> types() {
        return new TreeSet(Arrays.asList(
                ...
                REGISTRATION_CONFIRMATION, REGISTRATION_VERIFY_ACCOUNT, REGISTRATION_CONFIRMATION_REQUESTED, REGISTRATION_CONFIRMATION_EMAIL_SENT, REGISTRATION_VERIFY_EMAIL_SENT, FORGOT_PASSWORD_REQUESTED,
