...
public interface EventType {
    ...
    String REGISTRATION_VERIFY_ACCOUNT_EMAIL_SENT = "REGISTRATION_VERIFY_ACCOUNT_EMAIL_SENT";
    ...
    static Collection<String> types() {
        return new TreeSet(Arrays.asList(
                ...
                REGISTRATION_CONFIRMATION, REGISTRATION_VERIFY_ACCOUNT, REGISTRATION_CONFIRMATION_REQUESTED, REGISTRATION_CONFIRMATION_EMAIL_SENT,REGISTRATION_VERIFY_ACCOUNT_EMAIL_SENT, FORGOT_PASSWORD_REQUESTED,
