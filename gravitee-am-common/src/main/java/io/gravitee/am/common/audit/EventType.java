...
public interface EventType {
    ...
    static Collection<String> types() {
        return new TreeSet(Arrays.asList(USER_LOGIN, USER_LOGOUT, USER_CREATED, USER_UPDATED, USER_DELETED, USER_LOCKED, USER_UNLOCKED, USER_ENABLED, USER_DISABLED, USER_PASSWORD_RESET,
                USER_REGISTERED, USER_CONSENT_CONSENTED, USER_CONSENT_REVOKED, USER_ROLES_ASSIGNED, REGISTRATION_CONFIRMATION, REGISTRATION_CONFIRMATION_REQUESTED, FORGOT_PASSWORD_REQUESTED, DOMAIN_CREATED, DOMAIN_UPDATED,
                ...
                ROLE_DELETED, SCOPE_CREATED, SCOPE_UPDATED, SCOPE_DELETED, TAG_CREATED, TAG_UPDATED, TAG_DELETED, POLICY_CREATED, POLICY_UPDATED, POLICY_DELETED, MEMBERSHIP_CREATED, MEMBERSHIP_UPDATED, MEMBERSHIP_DELETED
        ));
    }
}
