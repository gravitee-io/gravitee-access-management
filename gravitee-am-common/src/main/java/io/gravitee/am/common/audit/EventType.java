...
public interface EventType {
    ...
    static Collection<String> types() {
        return new TreeSet(Arrays.asList(USER_LOGIN, USER_LOGOUT, USER_CREATED, USER_UPDATED, USER_DELETED, USER_PASSWORD_RESET,
                ...
                ROLE_DELETED, SCOPE_CREATED, SCOPE_UPDATED, SCOPE_DELETED, TAG_CREATED, TAG_UPDATED, TAG_DELETED
        ));
    }
}
