...
>>>>>>> 0bf2b2f (feat(webauthn): Client-Side Error Monitoring and Server-Side Logging)
                ...
                MFA_RATE_LIMIT_REACHED, PASSWORD_POLICY_CREATED, PASSWORD_POLICY_UPDATED, PASSWORD_POLICY_DELETED
        ));
    }
