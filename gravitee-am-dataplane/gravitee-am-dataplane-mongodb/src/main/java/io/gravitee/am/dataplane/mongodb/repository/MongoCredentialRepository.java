...
import io.gravitee.am.dataplane.mongodb.repository.model.CredentialMongo;
...
import static io.gravitee.am.repository.mongodb.common.MongoUtils.*;
 ...
 */
@Component
public class MongoCredentialRepository extends AbstractDataPlaneMongoRepository implements CredentialRepository {
    ...
    @PostConstruct
    public void init() {
        credentialsCollection = mongoDatabase.getCollection("webauthn_credentials", CredentialMongo.class);
        MongoUtils.init(credentialsCollection);
