...
import io.gravitee.am.dataplane.mongodb.repository.model.uma.AccessPolicyMongo;
 ...
 */
@Component
public class MongoAccessPolicyRepository extends AbstractDataPlaneMongoRepository implements AccessPolicyRepository {
    ...
    @PostConstruct
    public void init() {
        accessPoliciesCollection = mongoDatabase.getCollection(COLLECTION_NAME, AccessPolicyMongo.class);
        MongoUtils.init(accessPoliciesCollection);
