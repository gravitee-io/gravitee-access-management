...
import io.gravitee.am.dataplane.mongodb.repository.model.UserActivityMongo;
 ...
 */
@Component
public class MongoUserActivityRepository extends AbstractDataPlaneMongoRepository implements UserActivityRepository {
    ...
    @PostConstruct
    public void init() {
        userActivityCollection = mongoDatabase.getCollection("user_activities", UserActivityMongo.class);
        MongoUtils.init(userActivityCollection);
