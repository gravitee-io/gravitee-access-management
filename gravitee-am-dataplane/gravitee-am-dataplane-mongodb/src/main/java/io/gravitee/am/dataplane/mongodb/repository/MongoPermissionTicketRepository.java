...
import io.gravitee.am.dataplane.mongodb.repository.model.uma.PermissionRequestMongo;
import io.gravitee.am.dataplane.mongodb.repository.model.uma.PermissionTicketMongo;
 ...
 */
@Component
public class MongoPermissionTicketRepository extends AbstractDataPlaneMongoRepository implements PermissionTicketRepository {
    ...
    @PostConstruct
    public void init() {
        permissionTicketCollection = mongoDatabase.getCollection(COLLECTION_NAME, PermissionTicketMongo.class);
        MongoUtils.init(permissionTicketCollection);
