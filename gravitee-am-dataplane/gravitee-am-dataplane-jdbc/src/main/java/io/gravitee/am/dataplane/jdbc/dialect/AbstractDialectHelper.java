...
public abstract class AbstractDialectHelper implements DatabaseDialectHelper {
    ...
    protected StringBuilder buildSearchUser(boolean wildcard, StringBuilder builder) {
        return builder.append("u.reference_id = :refId")
                ...
                .append(" AND (")
                .append(" UPPER(u.username) ").append(wildcard ? LIKE : "= ")
                .append(VALUE)
                .append(" OR UPPER(u.email) ").append(wildcard ? LIKE : "= ")
                .append(VALUE)
                .append(" OR UPPER(u.additional_information_email) ").append(wildcard ? LIKE : "= ")
                .append(VALUE)
                .append(" OR UPPER(u.display_name) ").append(wildcard ? LIKE : "= ")
                .append(VALUE)
                .append(" OR UPPER(u.first_name) ").append(wildcard ? LIKE : "= ")
                .append(VALUE)
                .append(" OR UPPER(u.last_name) ").append(wildcard ? LIKE : "= ")
                .append(VALUE)
                .append(" ) ");
    }
