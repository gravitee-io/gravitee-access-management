 ...
 */
package io.gravitee.am.dataplane.jdbc.dialect;
...
public class PostgresqlHelper extends AbstractDialectHelper {
    ...
    protected StringBuilder buildSearchUser(boolean wildcard, StringBuilder builder) {
        return builder.append("u.reference_id = :refId")
                ...
                .append(" AND (")
                .append(" UPPER(u.username) ").append(wildcard ? SQL_LIKE : "= ")
                .append(VALUE_PARAM)
                .append(" OR UPPER(u.email) ").append(wildcard ? SQL_LIKE : "= ")
                .append(VALUE_PARAM)
                .append(" OR UPPER(u.additional_information->>'email') ").append(wildcard ? SQL_LIKE : "= ")
                .append(VALUE_PARAM)
                .append(" OR UPPER(u.display_name) ").append(wildcard ? SQL_LIKE : "= ")
                .append(VALUE_PARAM)
                .append(" OR UPPER(u.first_name) ").append(wildcard ? SQL_LIKE : "= ")
                .append(VALUE_PARAM)
                .append(" OR UPPER(u.last_name) ").append(wildcard ? SQL_LIKE : "= ")
                .append(VALUE_PARAM)
                .append(" ) ");
    }
