 ...
 */
public class X509Converter extends DozerConverter<List, String> {

    public X509Converter() {
    ...
    public List convertFrom(String s, List bean) {
        return JSONMapper.toCollectionOfBean(s, new TypeReference<List<Certificate>>(){});
    }
}
