...
@Configuration
@ComponentScan("io.gravitee.am.dataplane.jdbc.repository")
public class JdbcDataPlaneTestConfiguration extends AbstractRepositoryConfiguration {
    private final Logger LOGGER = LoggerFactory.getLogger(JdbcDataPlaneTestConfiguration.class);
    ...
    protected Optional<Converter> jsonConverter() {
        if (provider.getDatabaseType().equals("postgresql")) {
            return JdbcDataPlaneSpringConfiguration.instantiatePostgresJsonConverter();
        }
