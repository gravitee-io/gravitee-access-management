...
public interface CertificateCredentialRepository extends CrudRepository<CertificateCredential, String> {
    ...
    /**
     * Find certificate credential by subjectDN, issuerDN and serialNumber
     */
    Maybe<CertificateCredential> findBySubjectAndIssuerAndSerialNumber(ReferenceType referenceType,
                                                                       String referenceId,
                                                                       String subjectDN,
                                                                       String issuerDN,
                                                                       String serialNumber);
