...
@NgModule({
  ...
  declarations: [GioEeUnlockDialogComponent],
  exports: [GioEeUnlockDialogComponent],
  entryComponents: [GioEeUnlockDialogComponent],
})
export class GioEeUnlockDialogModule {}
