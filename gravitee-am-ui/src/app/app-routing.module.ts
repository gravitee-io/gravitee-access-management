    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'certificates/new', component: CertificateCreationComponent },
          {
          ...
          },
          {
            ...
            children: [
              ...
              { path: 'applications', component: UserApplicationsComponent, resolve: { consents: ConsentsResolver } },
              {
                ...
                resolve: { application: ApplicationResolver, consents: ConsentsResolver },
              },
          ...
          },
          {
            ...
            children: [
              ...
              { path: 'settings', component: ClientRegistrationSettingsComponent, resolve: { domain: DomainResolver } },
              {
                ...
                resolve: { domain: DomainResolver, scopes: ScopesResolver },
              },
              {
                path: 'allowed-scope',
              ...
              },
              {
                ...
                resolve: { domain: DomainResolver, apps: ApplicationsResolver },
              },
            ],
          },
        ],
