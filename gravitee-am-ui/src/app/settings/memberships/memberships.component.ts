...
export class SettingsMembershipsComponent implements OnInit {
  ...
  add(membership) {
    this.organizationService.addMember(membership.memberId, membership.memberType, membership.role).subscribe(() => {
      this.reloadMembers();
  ...
  delete(membershipId) {
    this.organizationService.removeMember(membershipId).subscribe(() => {
  ...
  update(member) {
    this.organizationService.addMember(member.memberId, member.memberType, member.role).subscribe(() => {
