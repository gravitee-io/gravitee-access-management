...
export class DomainComponent implements OnInit {
  ...
  initBreadcrumb() {
    ...
    this.breadcrumbService.addFriendlyNameForRouteRegex('/domains/'+this.domain.id+'/(clients|providers|certificates|roles)/.*', ' ');
    this.breadcrumbService.addFriendlyNameForRouteRegex('/domains/'+this.domain.id+'/(clients|providers|certificates|roles)/new$', 'new');
