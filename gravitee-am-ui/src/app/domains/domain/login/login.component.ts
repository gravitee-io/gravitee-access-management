...
export class DomainLoginComponent implements OnInit, AfterViewInit {
  domainId: string;
  domainLoginForm: any = {};
  ...
  openLoginInfo() {
    this.dialog.open(LoginInfoDialog);
  }
...
export class LoginInfoDialog {
  constructor(public dialogRef: MdDialogRef<LoginInfoDialog>) {}
}
