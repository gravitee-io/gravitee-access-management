...
import { Page } from '../../services/api.model';
import {
...
export class McpServersService {
  ...
  findByDomain(domainId: string, page: number, size: number): Observable<Page<McpServer>> {
    return this.service.findByDomain(domainId, ProtectedResourceType.MCP_SERVER, page, size).pipe(
      map(
        (page) =>
          ({
            ...page,
