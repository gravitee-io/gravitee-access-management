...
/** How many resource servers one lookup returns; the search term is what narrows a longer list. */
export const DEFAULT_RESOURCE_SERVER_LIMIT = 10;

/** The largest page the endpoint serves; asked for once so existing mappings keep their label. */
export const MAX_RESOURCE_SERVER_LIMIT = 100;

/** How long the dropdown waits after a keystroke before it asks the server again. */
export const RESOURCE_SERVER_SEARCH_DEBOUNCE_MS = 400;
