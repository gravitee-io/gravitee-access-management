...
public class DeviceIdentifierNotFoundException extends AbstractNotFoundException {
    ...
    public DeviceIdentifierNotFoundException(String deviceIdentifierId) {
        this.deviceIdentifier = deviceIdentifierId;
    }

    @Override
    public String getMessage() {
        return "Device Identifier plugin [" + deviceIdentifier + "] can not be found.";
    }
}
