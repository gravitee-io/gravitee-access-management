...
import io.gravitee.am.management.service.purge.ExpiredDataSweeperDispatcherImpl;
import io.gravitee.am.repository.common.ExpiredDataSweeperDispatcher;
...
public class ManagementPurgeServiceConfiguration {
    ...
    public ScheduledPurgeService scheduledPurgeService(@Value("${services.purge.enabled:true}") boolean enabled,
                                                       ...
                                                       ExpiredDataSweeperDispatcher sweeper) {
        return factory.createPurgeService(enabled, cron, excluded, taskScheduler, sweeper);
    }

    @Bean
    public ExpiredDataSweeperDispatcherImpl expiredDataSweepers() {
        return new ExpiredDataSweeperDispatcherImpl();
    }
