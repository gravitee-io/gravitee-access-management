...
public class AuthenticationDeviceNotifierPluginSchemaNotFoundException extends AbstractNotFoundException {
    ...
    public AuthenticationDeviceNotifierPluginSchemaNotFoundException(String plugin) {
        this.plugin = plugin;
    }

    @Override
    public String getMessage() {
        return "Authentication Device Notifier plugin schema for [" + plugin + "] can not be found.";
    }
}
