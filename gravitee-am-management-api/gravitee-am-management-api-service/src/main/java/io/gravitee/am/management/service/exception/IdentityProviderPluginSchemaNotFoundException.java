...
public class IdentityProviderPluginSchemaNotFoundException extends AbstractNotFoundException {
    ...
    public IdentityProviderPluginSchemaNotFoundException(String identityProvider) {
        this.identityProvider = identityProvider;
    }

    @Override
    public String getMessage() {
        return "Identity provider plugin schema for [" + identityProvider + "] can not be found.";
    }
}
