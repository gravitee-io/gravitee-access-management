...
public class UiNotificationDefinitionFactoryTest {
    ...
    public void definition_factory_test_certificate(){
        ...
        var factory = new UiNotificationDefinitionFactory<>(mapper, notifierSettings);
        ...
        factory.buildNotificationDefinition(sub).test()
                ...
                .assertValue(def ->
                        def.getResourceId().equals("id") &&
                                def.getConfiguration().contains("\"template\":\"certificate_expiration\"") &&
                                def.getType().equals(TYPE_UI_NOTIFIER) &&
    ...
    public void definition_factory_test_client_secret(){
        ...
        factory.buildNotificationDefinition(sub).test()
                ...
                .assertValue(def ->
                        def.getResourceId().equals("id") &&
                                def.getConfiguration().contains("\"template\":\"client_secret_expiration\"") &&
                                def.getType().equals(TYPE_UI_NOTIFIER) &&
