...
public class AuthorizationEnginesPluginResource {
    ...
    public AuthorizationEnginePluginResource getAuthorizationEnginePluginResource() {
        return resourceContext.getResource(AuthorizationEnginePluginResource.class);
    }
}
