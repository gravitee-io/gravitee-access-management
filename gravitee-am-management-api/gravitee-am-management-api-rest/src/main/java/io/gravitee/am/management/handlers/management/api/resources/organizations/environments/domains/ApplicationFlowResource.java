 ...
 */
public class ApplicationFlowResource extends AbstractResource {
    ...
    public void get(
        ...
        checkAnyPermission(organizationId, environmentId, domain, Permission.APPLICATION_FLOW, Acl.READ)
