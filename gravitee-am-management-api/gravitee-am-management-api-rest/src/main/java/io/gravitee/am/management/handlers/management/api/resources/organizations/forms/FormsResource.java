...
public class FormsResource extends AbstractResource {
    ...
    @ApiOperation(
        value = "Find an organization form template",
    ...
    public void get(
        ...
        checkPermission(ReferenceType.ORGANIZATION, organizationId, Permission.ORGANIZATION_FORM, Acl.READ)
            .andThen(
                formService
                    .findByTemplate(ReferenceType.ORGANIZATION, organizationId, formTemplate.template())
    ...
    @ApiOperation(value = "Create a form", notes = "User must have the ORGANIZATION_FORM[CREATE] permission on the specified organization")
    @ApiResponses(
    ...
    public void create(
        ...
        checkPermission(ReferenceType.ORGANIZATION, organizationId, Permission.ORGANIZATION_FORM, Acl.CREATE)
            .andThen(
                formService
                    .create(ReferenceType.ORGANIZATION, organizationId, newForm, authenticatedUser)
                    .map(
                        form ->
