...
public class ApplicationFlowsResource extends AbstractResource {
    ...
    public void list(
        ...
        checkAnyPermission(organizationId, environmentId, domain, ReferenceType.APPLICATION, application, Permission.APPLICATION_FLOW, Acl.LIST)
    ...
    public void update(
        ...
        checkAnyPermission(organizationId, environmentId, domain, ReferenceType.APPLICATION, application, Permission.APPLICATION_FLOW, Acl.UPDATE)
