 ...
 */
package io.gravitee.am.management.handlers.management.api.manager.idp.impl;
 ...
 */
public class UserProviderManagerImpl implements UserProviderManager, InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(UserProviderManagerImpl.class);
