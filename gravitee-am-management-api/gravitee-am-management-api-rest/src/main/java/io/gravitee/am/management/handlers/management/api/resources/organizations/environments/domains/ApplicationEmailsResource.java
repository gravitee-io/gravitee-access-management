...
public class ApplicationEmailsResource extends AbstractResource {
    ...
    public void get(
        ...
        checkPermissions(or(of(ReferenceType.APPLICATION, application, Permission.APPLICATION_EMAIL_TEMPLATE, Acl.READ),
    ...
    public void create(
        ...
        checkPermissions(or(of(ReferenceType.DOMAIN, domain, Permission.APPLICATION_EMAIL_TEMPLATE, Acl.CREATE),
