...
public class ApplicationEmailsResource extends AbstractResource {
    ...
    @ApiOperation(
        value = "Find a email for an application",
        ...
        checkAnyPermission(organizationId, environmentId, domain, application, Permission.APPLICATION_EMAIL_TEMPLATE, Acl.READ)
            .andThen(
                emailTemplateService
                    .findByDomainAndClientAndTemplate(domain, application, emailTemplate.template())
    ...
    @ApiOperation(
        value = "Create a email for an application",
