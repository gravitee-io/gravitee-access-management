...
public class SettingsResource extends AbstractResource {
    ...
    @ApiOperation(
        value = "Get organization main settings",
    ...
    public void get(@PathParam("organizationId") String organizationId, @Suspended final AsyncResponse response) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(
        value = "Update platform main settings",
