 ...
 */
package io.gravitee.am.management.standalone.container;

import ch.qos.logback.classic.LoggerContext;
import ch.qos.logback.classic.joran.JoranConfigurator;
import ch.qos.logback.core.joran.spi.JoranException;
import ch.qos.logback.core.util.StatusPrinter;
import io.gravitee.am.management.standalone.spring.PropertiesConfiguration;
...
public class Container {
    ...
    private void initializeContext() {
        LoggerFactory.getLogger(Container.class).info("Initializing Gravitee.io Access Management API context...");
     ...
     */
    public void start() {
        LoggerFactory.getLogger(Container.class).info("Start Gravitee.io Access Management API...");
        ...
        try {
            ...
            LoggerFactory.getLogger(Container.class).error("An unexpected error occurs while starting Gravitee.io Access Management API", ex);
            stop();
        }
    }
    ...
    public void stop() {
        if (! stopped) {
            LoggerFactory.getLogger(Container.class).info("Shutting-down Gravitee.io Access Management API...");
