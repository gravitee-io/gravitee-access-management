...
public class GroupMemberResource extends AbstractResource {
    ...
    public void addMember(@PathParam("group") String group,
        ...
        domainService.findMaster()
                ...
                .flatMapSingle(masterDomain -> groupService.findById(group)
                        ...
                        .flatMapSingle(group1 -> userService.findById(userId)
                                ...
                                .flatMapSingle(user -> {
                                    ...
                                    return groupService.update(masterDomain.getId(), group, updateGroup, authenticatedUser);
                                })
                        )
                )
    ...
    public void removeMember(@PathParam("group") String group,
                             @PathParam("member") String userId,
                             @Suspended final AsyncResponse response) {
        final io.gravitee.am.identityprovider.api.User authenticatedUser = getAuthenticatedUser();
