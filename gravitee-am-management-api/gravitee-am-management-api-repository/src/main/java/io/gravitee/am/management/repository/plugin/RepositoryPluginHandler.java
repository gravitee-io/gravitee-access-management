 ...
 */
package io.gravitee.am.management.repository.plugin;

import io.gravitee.am.management.repository.proxy.AbstractProxy;
...
public class RepositoryPluginHandler implements PluginHandler, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        // The management api needs 2 repositories :
        // 1_ Management
