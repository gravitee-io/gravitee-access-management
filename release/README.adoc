...
This option is to release hotfix of specific version. This step will only publish new docker image that can be provided to customer.


[source, shell]
----
npm run am-release -- \
  --branch hotfix-branch --fix-version 4.1.1-hotfix \
  --dry-run \
  release-hotfix
----
