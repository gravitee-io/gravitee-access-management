...
import io.gravitee.am.plugins.resource.core.impl.ResourcePluginManagerImpl;
...
public class ResourceSpringConfiguration {
    ...
    public ResourcePluginManager resourcePluginManager(
        ...
        return new ResourcePluginManagerImpl(pluginContextFactory, resourceConfigurationFactory);
    }
