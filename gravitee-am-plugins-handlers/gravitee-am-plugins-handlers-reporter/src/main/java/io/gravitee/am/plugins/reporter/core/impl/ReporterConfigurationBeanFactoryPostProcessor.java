 ...
 */
public class ReporterConfigurationBeanFactoryPostProcessor implements BeanFactoryPostProcessor {

    private final ReporterConfiguration configuration;

    ReporterConfigurationBeanFactoryPostProcessor(ReporterConfiguration configuration) {
