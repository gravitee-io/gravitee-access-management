...
import io.gravitee.am.plugins.protocol.core.impl.ProtocolPluginManagerImpl;
...
public class ProtocolSpringConfiguration {
    ...
    public ProtocolPluginManager protocolPluginManager(
        ...
        return new ProtocolPluginManagerImpl(pluginContextFactory, pluginClassLoaderFactory);
    }
}
