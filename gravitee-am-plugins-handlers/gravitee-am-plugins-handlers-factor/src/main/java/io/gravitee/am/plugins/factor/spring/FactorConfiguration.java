...
import io.gravitee.am.plugins.factor.core.impl.FactorConfigurationFactoryImpl;
import io.gravitee.am.plugins.factor.core.impl.FactorPluginManagerImpl;
...
public class FactorConfiguration {
    ...
    public FactorPluginManager factorPluginManager() {
        return new FactorPluginManagerImpl();
    }
