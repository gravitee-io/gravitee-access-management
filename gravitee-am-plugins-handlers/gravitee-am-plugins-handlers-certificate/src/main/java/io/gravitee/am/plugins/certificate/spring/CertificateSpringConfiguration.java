...
public class CertificateSpringConfiguration {
    ...
    public CertificatePluginManager certificatePluginManager(
            ...
            ConfigurationFactory<CertificateConfiguration> certConfigurationFactory
    ) {
        return new CertificatePluginManager(pluginContextFactory, certConfigurationFactory);
    }
