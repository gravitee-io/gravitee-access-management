...
public class ExtensionGrantPluginManager
    ...
    private static class ExtensionGrantTrustedIssuerResolverFactoryPostProcessor extends NamedBeanFactoryPostProcessor<TrustedIssuerDirectory> {
        private ExtensionGrantTrustedIssuerResolverFactoryPostProcessor(TrustedIssuerDirectory trustedIssuerResolver) {
