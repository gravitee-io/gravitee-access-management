 ...
 */
public class ExtensionGrantPluginManagerImpl extends ExtensionGrantPluginManager {
    ...
    public ExtensionGrantPluginManagerImpl(PluginContextFactory pluginContextFactory,
