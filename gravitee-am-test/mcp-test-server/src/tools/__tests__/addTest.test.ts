...
describe('addTest tool', () => {
  ...
  beforeEach(() => {
    ...
    handler = createAddTestHandler(testMetadataManager);
  ...
  it('should return success response with testId and test when metadata and test are valid', () => {
  ...
  it('should return 400 error when test is missing from request body', () => {
    testMetadataManager.setMetadata('test-123', 'token-abc', 'client-id', 'client-secret', undefined, 'test-domain');
    mockRequest = {
      body: {},
    };
  ...
  it('should return 400 error when test is not a string', () => {
    testMetadataManager.setMetadata('test-123', 'token-abc', 'client-id', 'client-secret', undefined, 'test-domain');
    mockRequest = {
      body: {
        test: 123,
  ...
  it('should return 400 error when test is empty string', () => {
    testMetadataManager.setMetadata('test-123', 'token-abc', 'client-id', 'client-secret', undefined, 'test-domain');
    mockRequest = {
      body: {
        test: '',
