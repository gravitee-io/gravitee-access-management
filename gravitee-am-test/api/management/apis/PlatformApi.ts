...
import {AlertServiceStatusEntity, AlertServiceStatusEntityFromJSON, InstallationEntity, InstallationEntityFromJSON, NotifierPlugin, NotifierPluginFromJSON, Role, RoleFromJSON, } from '../models';
...
export class PlatformApi extends runtime.BaseAPI {
     ...
     */
    async get26Raw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<InstallationEntity>> {
     ...
     * Get installation information
     */
    async get26(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<InstallationEntity> {
        const response = await this.get26Raw(initOverrides);
     ...
     */
    async get27Raw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Get current node License
     */
    async get27(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
        await this.get27Raw(initOverrides);
    }
    ...
    async get28Raw(requestParameters: Get28Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.authDeviceNotifierId === null || requestParameters.authDeviceNotifierId === undefined) {
            throw new runtime.RequiredError('authDeviceNotifierId','Required parameter requestParameters.authDeviceNotifierId was null or undefined when calling get28.');
        }
    ...
    async get38Raw(requestParameters: Get38Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.extensionGrant === null || requestParameters.extensionGrant === undefined) {
            throw new runtime.RequiredError('extensionGrant','Required parameter requestParameters.extensionGrant was null or undefined when calling get38.');
        }
     ...
     * Get a system role
     */
    async get39Raw(requestParameters: Get39Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Role>> {
        if (requestParameters.role === null || requestParameters.role === undefined) {
            throw new runtime.RequiredError('role','Required parameter requestParameters.role was null or undefined when calling get39.');
        }
     ...
     * Get a system role
     */
    async get39(requestParameters: Get39Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Role> {
    ...
    async getSchema4Raw(requestParameters: GetSchema4Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.factor === null || requestParameters.factor === undefined) {
            throw new runtime.RequiredError('factor','Required parameter requestParameters.factor was null or undefined when calling getSchema4.');
        }
     ...
     */
    async getSchema6Raw(requestParameters: GetSchema6Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.notifierId === null || requestParameters.notifierId === undefined) {
            throw new runtime.RequiredError('notifierId','Required parameter requestParameters.notifierId was null or undefined when calling getSchema6.');
        }
    ...
    async getSchema9Raw(requestParameters: GetSchema9Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.resource === null || requestParameters.resource === undefined) {
            throw new runtime.RequiredError('resource','Required parameter requestParameters.resource was null or undefined when calling getSchema9.');
        }
    ...
    /**
     */
    async getUserEmailRequired(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
        await this.getUserEmailRequiredRaw(initOverrides);
    }
     ...
     */
    async list38Raw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * List audit event types
     */
    async list38(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
        await this.list38Raw(initOverrides);
    }
