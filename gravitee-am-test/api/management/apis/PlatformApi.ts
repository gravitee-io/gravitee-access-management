...
export class PlatformApi extends runtime.BaseAPI {
    ...
    async get29Raw(requestParameters: Get29Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.certificate === null || requestParameters.certificate === undefined) {
            throw new runtime.RequiredError('certificate','Required parameter requestParameters.certificate was null or undefined when calling get29.');
        }
     ...
     * Get a system role
     */
    async get37Raw(requestParameters: Get37Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Role>> {
        if (requestParameters.role === null || requestParameters.role === undefined) {
            throw new runtime.RequiredError('role','Required parameter requestParameters.role was null or undefined when calling get37.');
        }
     ...
     * Get a system role
     */
    async get37(requestParameters: Get37Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Role> {
        const response = await this.get37Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async get38Raw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<InstallationEntity>> {
        const queryParameters: any = {};
     ...
     * Get installation information
     */
    async get38(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<InstallationEntity> {
        const response = await this.get38Raw(initOverrides);
        return await response.value();
    }
