...
import {Entrypoint, EntrypointFromJSON, NewEntrypoint, NewEntrypointToJSON, UpdateEntrypoint, UpdateEntrypointToJSON, } from '../models';
...
export class EntrypointsApi extends runtime.BaseAPI {
    ...
    async _deleteRaw(requestParameters: DeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.entrypointId === null || requestParameters.entrypointId === undefined) {
            throw new runtime.RequiredError('entrypointId','Required parameter requestParameters.entrypointId was null or undefined when calling _delete.');
        }
    ...
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.newEntrypoint === null || requestParameters.newEntrypoint === undefined) {
            throw new runtime.RequiredError('newEntrypoint','Required parameter requestParameters.newEntrypoint was null or undefined when calling create.');
        }
     ...
     */
    async get2Raw(requestParameters: Get2Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Entrypoint>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
        ...
        if (requestParameters.entrypointId === null || requestParameters.entrypointId === undefined) {
            throw new runtime.RequiredError('entrypointId','Required parameter requestParameters.entrypointId was null or undefined when calling get2.');
        }
     ...
     * List entrypoints
     */
    async list1Raw(requestParameters: List1Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Array<Entrypoint>>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
     ...
     */
    async updateRaw(requestParameters: UpdateRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Entrypoint>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
        ...
        if (requestParameters.entrypointId === null || requestParameters.entrypointId === undefined) {
            throw new runtime.RequiredError('entrypointId','Required parameter requestParameters.entrypointId was null or undefined when calling update.');
        }

        if (requestParameters.updateEntrypoint === null || requestParameters.updateEntrypoint === undefined) {
            throw new runtime.RequiredError('updateEntrypoint','Required parameter requestParameters.updateEntrypoint was null or undefined when calling update.');
        }
