...
import {Domain, DomainFromJSON, Environment, EnvironmentFromJSON, MembershipListItem, MembershipListItemFromJSON, NewMembership, NewMembershipToJSON, PatchOrganization, PatchOrganizationToJSON, } from '../models';
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async addOrUpdateMember2Raw(requestParameters: AddOrUpdateMember2Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.newMembership === null || requestParameters.newMembership === undefined) {
            throw new runtime.RequiredError('newMembership','Required parameter requestParameters.newMembership was null or undefined when calling addOrUpdateMember2.');
        }
    ...
    /**
     */
    async getExternalGrammarRaw(requestParameters: GetExternalGrammarRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.path === null || requestParameters.path === undefined) {
            throw new runtime.RequiredError('path','Required parameter requestParameters.path was null or undefined when calling getExternalGrammar.');
        }
    ...
    /**
     */
    async getExternalGrammar(requestParameters: GetExternalGrammarRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
    ...
    async patchRaw(requestParameters: PatchRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Domain>> {
        ...
        if (requestParameters.patchOrganization === null || requestParameters.patchOrganization === undefined) {
            throw new runtime.RequiredError('patchOrganization','Required parameter requestParameters.patchOrganization was null or undefined when calling patch.');
        }
     ...
     */
    async permissions2Raw(requestParameters: Permissions2Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
