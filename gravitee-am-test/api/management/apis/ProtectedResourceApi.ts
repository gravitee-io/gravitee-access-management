...
/**
 * Temporary type definition for PatchProtectedResource until it's generated from OpenAPI spec
 * TODO: Replace with generated PatchProtectedResource model after regenerating API client
 */
...
export class ProtectedResourceApi extends runtime.BaseAPI {
    ...
    async patchProtectedResourceRaw(requestParameters: PatchProtectedResourceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ProtectedResourcePrimaryData>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.patchProtectedResource as any,
        }, initOverrides);
