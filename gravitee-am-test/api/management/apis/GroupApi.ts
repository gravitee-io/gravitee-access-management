...
export class GroupApi extends runtime.BaseAPI {
   ...
   */
  async list23Raw(
    requestParameters: List23Request,
    initOverrides?: RequestInit | runtime.InitOverideFunction,
  ): Promise<runtime.ApiResponse<User>> {
    if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
      throw new runtime.RequiredError(
        'organizationId',
        'Required parameter requestParameters.organizationId was null or undefined when calling list23.',
      );
    }
  ...
  async removeMember3Raw(
    ...
    if (requestParameters.group === null || requestParameters.group === undefined) {
      throw new runtime.RequiredError(
        'group',
        'Required parameter requestParameters.group was null or undefined when calling removeMember3.',
      );
    }
  ...
  async updateOrganizationGroupRaw(
    ...
    if (requestParameters.group2 === null || requestParameters.group2 === undefined) {
      throw new runtime.RequiredError(
        'group2',
        'Required parameter requestParameters.group2 was null or undefined when calling updateOrganizationGroup.',
      );
    }
