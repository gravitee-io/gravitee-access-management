...
import {AccountAccessToken, AccountAccessTokenFromJSON, Audit, AuditFromJSON, BulkRequestNewOrganizationUser, BulkRequestNewOrganizationUserToJSON, BulkRequestNewUser, BulkRequestNewUserToJSON, BulkResponse, BulkResponseFromJSON, Credential, CredentialFromJSON, EmailValue, EmailValueToJSON, EnrolledFactorEntity, EnrolledFactorEntityFromJSON, NewAccountAccessToken, NewAccountAccessTokenToJSON, NewOrganizationUser, NewOrganizationUserFromJSON, NewOrganizationUserToJSON, NewUser, NewUserToJSON, Page, PageFromJSON, PasswordValue, PasswordValueToJSON, Role, RoleFromJSON, ScopeApprovalEntity, ScopeApprovalEntityFromJSON, StatusEntity, StatusEntityToJSON, UpdateUser, UpdateUserToJSON, User, UserEntity, UserEntityFromJSON, UserFromJSON, UserIdentityEntity, UserIdentityEntityFromJSON, UsernameEntity, UsernameEntityToJSON, UserNotificationContent, UserNotificationContentFromJSON, UserPage, UserPageFromJSON, } from '../models';
...
export interface BulkCreateOrganisationUserRequest {
    organizationId: string;
    bulkRequestNewOrganizationUser: BulkRequestNewOrganizationUser;
}
...
export interface GetUserActiveTokensRequest {
    organizationId: string;
    user: string;
}
...
export class UserApi extends runtime.BaseAPI {
     ...
     */
    async bulkCreateOrganisationUserRaw(requestParameters: BulkCreateOrganisationUserRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<NewOrganizationUser>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
            throw new runtime.RequiredError('organizationId','Required parameter requestParameters.organizationId was null or undefined when calling bulkCreateOrganisationUser.');
        }

        if (requestParameters.bulkRequestNewOrganizationUser === null || requestParameters.bulkRequestNewOrganizationUser === undefined) {
            throw new runtime.RequiredError('bulkRequestNewOrganizationUser','Required parameter requestParameters.bulkRequestNewOrganizationUser was null or undefined when calling bulkCreateOrganisationUser.');
        }
        ...
        const response = await this.request({
            path: `/organizations/{organizationId}/users/bulk`.replace(`{${"organizationId"}}`, encodeURIComponent(String(requestParameters.organizationId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: BulkRequestNewOrganizationUserToJSON(requestParameters.bulkRequestNewOrganizationUser),
        }, initOverrides);
     ...
     * Create a platform user or Service Account
     */
    async bulkCreateOrganisationUser(requestParameters: BulkCreateOrganisationUserRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<NewOrganizationUser> {
        const response = await this.bulkCreateOrganisationUserRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async createAccountAccessTokenRaw(requestParameters: CreateAccountAccessTokenRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<AccountAccessToken>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
            throw new runtime.RequiredError('organizationId','Required parameter requestParameters.organizationId was null or undefined when calling createAccountAccessToken.');
        }

        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling createAccountAccessToken.');
        }
        ...
        const response = await this.request({
            path: `/organizations/{organizationId}/users/{user}/tokens`.replace(`{${"organizationId"}}`, encodeURIComponent(String(requestParameters.organizationId))).replace(`{${"user"}}`, encodeURIComponent(String(requestParameters.user))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Generate an account access token for a user
     */
    async createAccountAccessToken(requestParameters: CreateAccountAccessTokenRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<AccountAccessToken> {
    ...
    async createOrganisationUserRaw(requestParameters: CreateOrganisationUserRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<NewOrganizationUser>> {
        ...
        if (requestParameters.newOrganizationUser === null || requestParameters.newOrganizationUser === undefined) {
            throw new runtime.RequiredError('newOrganizationUser','Required parameter requestParameters.newOrganizationUser was null or undefined when calling createOrganisationUser.');
        }
     ...
     * Get a user
     */
    async get25Raw(requestParameters: Get25Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<UserEntity>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
        ...
        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling get25.');
        }
     ...
     * Get a user
     */
    async get25(requestParameters: Get25Request, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<UserEntity> {
     ...
     */
    async getUserActiveTokensRaw(requestParameters: GetUserActiveTokensRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<AccountAccessToken>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
            throw new runtime.RequiredError('organizationId','Required parameter requestParameters.organizationId was null or undefined when calling getUserActiveTokens.');
        }

        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling getUserActiveTokens.');
        }
     ...
     * Get tokens of a user
     */
    async getUserActiveTokens(requestParameters: GetUserActiveTokensRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<AccountAccessToken> {
        const response = await this.getUserActiveTokensRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async listOrganisationUsersRaw(requestParameters: ListOrganisationUsersRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
            throw new runtime.RequiredError('organizationId','Required parameter requestParameters.organizationId was null or undefined when calling listOrganisationUsers.');
        }
     ...
     * List users of the organization
     */
    async listOrganisationUsers(requestParameters: ListOrganisationUsersRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
    ...
    async resetOrganizationUserPasswordRaw(requestParameters: ResetOrganizationUserPasswordRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.passwordValue === null || requestParameters.passwordValue === undefined) {
            throw new runtime.RequiredError('passwordValue','Required parameter requestParameters.passwordValue was null or undefined when calling resetOrganizationUserPassword.');
        }
     ...
     */
    async revokeAccountAccessTokenRaw(requestParameters: RevokeAccountAccessTokenRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
            throw new runtime.RequiredError('organizationId','Required parameter requestParameters.organizationId was null or undefined when calling revokeAccountAccessToken.');
        }

        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling revokeAccountAccessToken.');
        }

        if (requestParameters.tokenId === null || requestParameters.tokenId === undefined) {
            throw new runtime.RequiredError('tokenId','Required parameter requestParameters.tokenId was null or undefined when calling revokeAccountAccessToken.');
        }
        ...
        const response = await this.request({
            path: `/organizations/{organizationId}/users/{user}/tokens/{tokenId}`.replace(`{${"organizationId"}}`, encodeURIComponent(String(requestParameters.organizationId))).replace(`{${"user"}}`, encodeURIComponent(String(requestParameters.user))).replace(`{${"tokenId"}}`, encodeURIComponent(String(requestParameters.tokenId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Revoke an account access token
     */
    async revokeAccountAccessToken(requestParameters: RevokeAccountAccessTokenRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async updateOrganisationUsernameRaw(requestParameters: UpdateOrganisationUsernameRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<User>> {
        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
            throw new runtime.RequiredError('organizationId','Required parameter requestParameters.organizationId was null or undefined when calling updateOrganisationUsername.');
        }

        if (requestParameters.user === null || requestParameters.user === undefined) {
            throw new runtime.RequiredError('user','Required parameter requestParameters.user was null or undefined when calling updateOrganisationUsername.');
        }

        if (requestParameters.usernameEntity === null || requestParameters.usernameEntity === undefined) {
            throw new runtime.RequiredError('usernameEntity','Required parameter requestParameters.usernameEntity was null or undefined when calling updateOrganisationUsername.');
        }
        ...
        const response = await this.request({
            path: `/organizations/{organizationId}/users/{user}/username`.replace(`{${"organizationId"}}`, encodeURIComponent(String(requestParameters.organizationId))).replace(`{${"user"}}`, encodeURIComponent(String(requestParameters.user))),
            method: 'PATCH',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Update a user username
     */
    async updateOrganisationUsername(requestParameters: UpdateOrganisationUsernameRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<User> {
    ...
    async updateOrganizationUserRaw(requestParameters: UpdateOrganizationUserRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<User>> {
        ...
        if (requestParameters.updateUser === null || requestParameters.updateUser === undefined) {
            throw new runtime.RequiredError('updateUser','Required parameter requestParameters.updateUser was null or undefined when calling updateOrganizationUser.');
        }
    ...
    async updateOrganizationUserStatusRaw(requestParameters: UpdateOrganizationUserStatusRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<User>> {
        ...
        if (requestParameters.statusEntity === null || requestParameters.statusEntity === undefined) {
            throw new runtime.RequiredError('statusEntity','Required parameter requestParameters.statusEntity was null or undefined when calling updateOrganizationUserStatus.');
        }
