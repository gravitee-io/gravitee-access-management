...
export class UserApi extends runtime.BaseAPI {
  ...
  async createOrganisationUserRaw(
    ...
    if (requestParameters.user === null || requestParameters.user === undefined) {
      throw new runtime.RequiredError(
        'user',
        'Required parameter requestParameters.user was null or undefined when calling createOrganisationUser.',
      );
    }
   ...
   */
  async get23Raw(
    requestParameters: Get23Request,
    initOverrides?: RequestInit | runtime.InitOverideFunction,
  ): Promise<runtime.ApiResponse<UserEntity>> {
    if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
      throw new runtime.RequiredError(
        'organizationId',
        'Required parameter requestParameters.organizationId was null or undefined when calling get23.',
      );
    }
  ...
  async resetOrganizationUserPasswordRaw(
    ...
    if (requestParameters.password === null || requestParameters.password === undefined) {
      throw new runtime.RequiredError(
        'password',
        'Required parameter requestParameters.password was null or undefined when calling resetOrganizationUserPassword.',
      );
    }
  ...
  async updateOrganisationUsernameRaw(
    ...
    if (requestParameters.username === null || requestParameters.username === undefined) {
      throw new runtime.RequiredError(
        'username',
        'Required parameter requestParameters.username was null or undefined when calling updateOrganisationUsername.',
      );
    }
  ...
  async updateOrganizationUserRaw(
    ...
    if (requestParameters.user2 === null || requestParameters.user2 === undefined) {
      throw new runtime.RequiredError(
        'user2',
        'Required parameter requestParameters.user2 was null or undefined when calling updateOrganizationUser.',
      );
    }
  ...
  async updateOrganizationUserStatusRaw(
    ...
    if (requestParameters.status === null || requestParameters.status === undefined) {
      throw new runtime.RequiredError(
        'status',
        'Required parameter requestParameters.status was null or undefined when calling updateOrganizationUserStatus.',
      );
    }
