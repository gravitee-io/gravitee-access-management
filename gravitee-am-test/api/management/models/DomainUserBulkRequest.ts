 ...
 * @export
 */
export type DomainUserBulkRequest = { action: 'BulkCreateUser' } & BulkCreateUser | { action: 'BulkDeleteUser' } & BulkDeleteUser | { action: 'BulkUpdateUser' } & BulkUpdateUser | { action: 'CREATE' } & BulkCreateUser | { action: 'DELETE' } & BulkDeleteUser | { action: 'UPDATE' } & BulkUpdateUser;
