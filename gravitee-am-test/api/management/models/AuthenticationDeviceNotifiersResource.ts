...
export function AuthenticationDeviceNotifiersResourceFromJSONTyped(
  json: any,
  ...
  return {
    authenticationDeviceNotifierResource: !exists(json, 'authenticationDeviceNotifierResource')
      ? undefined
      : json['authenticationDeviceNotifierResource'],
  };
}
