...
import {
    BulkDeleteUser,
    BulkDeleteUserFromJSON,
    BulkDeleteUserFromJSONTyped,
    BulkDeleteUserToJSON,
} from './BulkDeleteUser';
import {
    BulkUpdateUser,
 ...
 * @export
 */
export type OrganizationUserBulkRequest = { action: 'BulkCreateOrganizationUser' } & BulkCreateOrganizationUser | { action: 'BulkDeleteUser' } & BulkDeleteUser | { action: 'BulkUpdateUser' } & BulkUpdateUser | { action: 'CREATE' } & BulkCreateOrganizationUser | { action: 'DELETE' } & BulkDeleteUser | { action: 'UPDATE' } & BulkUpdateUser;
