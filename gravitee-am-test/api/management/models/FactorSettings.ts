...
export function FactorSettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): FactorSettings {
    ...
    return {
        ...
        'applicationFactors': !exists(json, 'applicationFactors') ? undefined : ((json['applicationFactors'] as Array<any>).map(ApplicationFactorSettingsFromJSON)),
    };
}
...
export function FactorSettingsToJSON(value?: FactorSettings | null): any {
    ...
    return {
        ...
        'applicationFactors': value.applicationFactors === undefined ? undefined : ((value.applicationFactors as Array<any>).map(ApplicationFactorSettingsToJSON)),
    };
}
