...
import { AlertsResource, AlertsResourceFromJSON, AlertsResourceFromJSONTyped, AlertsResourceToJSON } from './AlertsResource';
import {
...
import { FactorsResource, FactorsResourceFromJSON, FactorsResourceFromJSONTyped, FactorsResourceToJSON } from './FactorsResource';
import { FlowsResource, FlowsResourceFromJSON, FlowsResourceFromJSONTyped, FlowsResourceToJSON } from './FlowsResource';
...
import { ReportersResource, ReportersResourceFromJSON, ReportersResourceFromJSONTyped, ReportersResourceToJSON } from './ReportersResource';
import { RolesResource, RolesResourceFromJSON, RolesResourceFromJSONTyped, RolesResourceToJSON } from './RolesResource';
import { ScopesResource, ScopesResourceFromJSON, ScopesResourceFromJSONTyped, ScopesResourceToJSON } from './ScopesResource';
import {
...
import { ThemesResource, ThemesResourceFromJSON, ThemesResourceFromJSONTyped, ThemesResourceToJSON } from './ThemesResource';
...
export function DomainResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): DomainResource {
  ...
  return {
    ...
    tokenGrantersResource: !exists(json, 'tokenGrantersResource')
      ? undefined
      : ExtensionGrantsResourceFromJSON(json['tokenGrantersResource']),
    ...
    dictionariesResource: !exists(json, 'dictionariesResource')
      ? undefined
      : I18nDictionariesResourceFromJSON(json['dictionariesResource']),
    ...
    serviceResourcesResource: !exists(json, 'serviceResourcesResource')
      ? undefined
      : ServiceResourcesResourceFromJSON(json['serviceResourcesResource']),
    ...
    botDetectionsResource: !exists(json, 'botDetectionsResource')
      ? undefined
      : BotDetectionsResourceFromJSON(json['botDetectionsResource']),
    deviceIdentifiersResource: !exists(json, 'deviceIdentifiersResource')
      ? undefined
      : DeviceIdentifiersResourceFromJSON(json['deviceIdentifiersResource']),
    deviceNotifiersResource: !exists(json, 'deviceNotifiersResource')
      ? undefined
      : AuthenticationDeviceNotifiersResourceFromJSON(json['deviceNotifiersResource']),
