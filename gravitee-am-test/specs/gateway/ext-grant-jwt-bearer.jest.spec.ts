...
export const testCryptData = {
    thirdParty: {
        sshRsa: "",
...
beforeAll(async () => {
    ...
    await createServiceApplication(
        domain.id,
        accessToken,
        'app',
        'app',
            ...
            accessToken,
            {
                settings: {
                    oauth: {
                        grantTypes: [
                            "client_credentials",
                            `urn:ietf:params:oauth:grant-type:jwt-bearer~${jwtBearerExtGrant.id}`
                        ],
                    },
                },
            },
