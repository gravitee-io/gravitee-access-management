...
afterAll(async () => {
  ...
  describe('AuthZen API - Basic Authorization Checks', () => {
    ...
    it('should allow owner to access via AuthZen', async () => {
  ...
  describe('AuthZen API - Request Validation', () => {
    ...
    it('should reject request with empty subject id', async () => {
      await evaluateAccessExpectError(
        testDomain.hrid,
        user1Token,
        {
    ...
    it('should reject request with missing resource', async () => {
      await evaluateAccessExpectError(
        testDomain.hrid,
        user1Token,
        {
  ...
  describe('AuthZen API - Properties Support', () => {
    ...
    it('should accept subject properties', async () => {
    ...
    it('should accept resource properties', async () => {
      const result = await evaluateAccess(
        testDomain.hrid,
        user1Token,
        authzenFactory.canAccess(testUser1.username, propsServerId, 'tool', {
    ...
    it('should accept action properties', async () => {
      const result = await evaluateAccess(
        testDomain.hrid,
        user1Token,
        authzenFactory.canAccess(testUser1.username, propsServerId, 'tool', {
    ...
    it('should accept context properties', async () => {
      const result = await evaluateAccess(
        testDomain.hrid,
        user1Token,
        authzenFactory.canAccess(testUser1.username, propsServerId, 'tool', {
  ...
  describe('AuthZen API - Dynamic Permission Changes', () => {
    ...
    it('should deny after tuple is removed', async () => {
    ...
    it('should handle role transition from owner to viewer', async () => {
  ...
  describe('AuthZen API - Edge Cases', () => {
    ...
    it('should handle special characters in resource id', async () => {
