...
describe('OAuth Grant Flows — Regression Suite', () => {
  describe('Authorization Code Flow (UC-AM49)', () => {
    ...
    it(`${jira('AM-2205')} should complete auth code flow and obtain access token`, async () => {
  ...
  describe('Authorization Code + PKCE Flow (UC-AM50)', () => {
    ...
    it(`${jira('AM-2238')} should complete auth code + PKCE (S256) flow`, async () => {
  ...
  describe('Implicit Flow (UC-AM51)', () => {
    ...
    it(`${jira('AM-2231')} should obtain access token via implicit flow`, async () => {
      const clientId = fixture.application.settings.oauth.clientId;
  ...
  describe('Resource Owner Password (UC-AM52)', () => {
    ...
    it(`${jira('AM-2229')} should obtain token via resource owner password grant`, async () => {
  ...
  describe('Client Credentials (UC-AM48)', () => {
    ...
    it(`${jira('AM-2213')} should obtain token via client credentials`, async () => {
      const response = await performPost(
        fixture.oidc.token_endpoint,
        '',
