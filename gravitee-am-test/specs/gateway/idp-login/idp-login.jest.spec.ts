...
describe('Identity Provider CRUD', () => {
  ...
  it(`${jira('AM-2204')} should create an identity provider`, async () => {
  ...
  it(`${jira('AM-2203')} should update an identity provider`, async () => {
  ...
  it(`${jira('AM-2202')} should delete an identity provider`, async () => {
...
describe('IdP Login Flows', () => {
  describe('Single Internal IdP (UC-AM23)', () => {
    ...
    it(`${jira('AM-2185')} should login via password grant with internal IdP`, async () => {
  ...
  describe('Multiple IdPs (UC-AM25)', () => {
    ...
    it(`${jira('AM-2180')} should login with user from either IdP`, async () => {
  ...
  describe('IdP Processing Order (UC-AM26)', () => {
    ...
    it(`${jira('AM-2179')} should respect IdP processing priority order`, async () => {
  ...
  describe('IdP Selection Rule (UC-AM27)', () => {
    ...
    it(`${jira('AM-2171')} should configure selection rule on IdP and login with unblocked IdP`, async () => {
