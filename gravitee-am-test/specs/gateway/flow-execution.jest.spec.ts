...
import {createDomain, deleteDomain, getDomainFlows, startDomain, updateDomainFlows} from "@management-commands/domain-management-commands";
			...
			lookupFlowAndResetPolicies(flows, FlowEntityTypeEnum.Login, "post", [
				{
					...
					"description": "",
					"configuration": JSON.stringify({"exitOnError":false,properties:[{claim:"claimFromGroovy",claimValue:"{#context.attributes['authFlow']['groovy-domain-all']}"}]}),
					"enabled": true,
					"condition": ""
			}
			])
			...
			lookupFlowAndResetPolicies(flows, FlowEntityTypeEnum.Login, "post", [
				{
					...
					"policy": "policy-am-enrich-profile",
					"description": "",
					"configuration": JSON.stringify({"exitOnError":false,properties:[{claim:"claimFromGroovy",claimValue:"{#context.attributes['groovy-domain-all']}"}]}),
					"enabled": true,
					"condition": ""
			}
			])
			...
			lookupFlowAndResetPolicies(flows, FlowEntityTypeEnum.Login, "post", [
				{
					...
					"policy": "policy-am-enrich-profile",
					"description": "",
					"configuration": JSON.stringify({"exitOnError":false,properties:[{claim:"claimFromAppGroovy",claimValue:"{#context.attributes['authFlow']['groovy-app-all']}"}]}),
					"enabled": true,
					"condition": ""
			}
			])
			...
			lookupFlowAndResetPolicies(domainFlows, FlowEntityTypeEnum.Root, "pre", [
				{
					...
					"condition": "",
					"enabled": true,
					"configuration": JSON.stringify({onRequestScript:'context.setAttribute("groovy-domain-all","domainRootInfoUpdatedAfterDisabled");'})
				}
			])
