...
describe('Domain Create (UC-AM5)', () => {
  ...
  it(`${jira('AM-2217')} should create a security domain`, async () => {
...
describe('Flow Policy Execution', () => {
  ...
  it(`${jira('AM-2199')} should execute a single policy in a login flow`, async () => {
  ...
  it(`${jira('AM-2198')} should execute multiple policies in a login flow`, async () => {
...
describe('i18n Dictionary (UC-AM66)', () => {
  ...
  it(`${jira('AM-2184')} should create a translation dictionary and add entries`, async () => {
    // Create dictionary
...
describe('API Verification', () => {
  ...
  it(`${jira('AM-2186')} should verify key Management API endpoints respond`, async () => {
