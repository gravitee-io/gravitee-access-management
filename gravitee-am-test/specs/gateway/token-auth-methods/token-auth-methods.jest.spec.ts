...
describe('Token Authentication Methods', () => {
  describe('client_secret_basic (UC-AM54)', () => {
    ...
    it(`${jira('AM-2225')} should obtain token using client_secret_basic`, async () => {
    ...
    it(`${jira('AM-2225')} should reject client_secret_post when basic is configured`, async () => {
      await performPost(
        fixture.oidc.token_endpoint,
        '',
  ...
  describe('client_secret_post (UC-AM55)', () => {
    ...
    it(`${jira('AM-2236')} should obtain token using client_secret_post`, async () => {
      const response = await performPost(
        fixture.oidc.token_endpoint,
        '',
        `grant_type=client_credentials&client_id=${encodeURIComponent(fixture.clientId)}&client_secret=${encodeURIComponent(fixture.clientSecret)}`,
  ...
  describe('client_secret_jwt (UC-AM56)', () => {
    ...
    it(`${jira('AM-2234')} should obtain token using client_secret_jwt`, async () => {
  ...
  describe('Refresh Token (UC-AM53)', () => {
    ...
    it(`${jira('AM-2228')} should obtain and use refresh token`, async () => {
