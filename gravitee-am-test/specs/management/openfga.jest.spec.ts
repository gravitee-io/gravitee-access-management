...
/**
 * OpenFGA + AuthZen - Comprehensive Integration Test Suite
 *
 * This test suite combines OpenFGA and AuthZen tests in a single file to avoid
 * duplicate configuration and setup. Both OpenFGA and AuthZen share the same
 * authorization engine, domain, and test infrastructure.
 *
 * Part 1: OpenFGA Management API (12 tests)
 * - Tests configuration and administration operations
 * - Store management, authorization models, relationship tuples, permission checks
 * - Uses admin access token for Management API calls
 *
 * Part 2: AuthZen Runtime API (21 tests)
 * - Tests runtime authorization evaluation via OpenID Authorization API 1.0
 * - Request validation, properties support, dynamic changes, edge cases
 * - Uses OAuth2 bearer tokens for gateway API calls
 *
 * Setup:
 * - Creates OpenFGA store and authorization model
 * - Configures Gravitee AM authorization engine
 * - Creates test users and OAuth2 application
 * - Sets up proper authentication for AuthZen API calls
 */
...
describe('OpenFGA Authorization Engine', () => {
    ...
    describe('Management API - Permission Checks', () => {
        ...
        it('should allow manage for owner', async () => {
        ...
        it('should deny access without tuple', async () => {
        ...
        it('should allow access for viewer', async () => {
        ...
        it('should deny manage for viewer', async () => {
