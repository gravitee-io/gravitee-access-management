...
consentFixture.describe('AM-6623/AM-6624: Consent revocation propagates to token tree', () => {
  consentFixture('AM-6623: consent revocation invalidates exchanged token tree', async (
    ...
    // Poll until tokens become inactive (consent revocation is async)
    await waitForTokenInactive(doIntrospect, exchangedToken);
  ...
  consentFixture('AM-6624: consent revocation invalidates branching token tree', async (
    ...
    // Both branches should become inactive
    await waitForTokenInactive(doIntrospect, branch1.body.access_token);
    await waitForTokenInactive(doIntrospect, branch2.body.access_token);
