 ...
 */
@Configuration
public class HttpAuthenticationDeviceProviderSpringConfiguration {
    ...
    public WebClient httpClient(WebClientBuilder webClientBuilder) {
        ...
        return webClientBuilder.createWebClient(vertx, httpClientOptions, configuration.getEndpoint(), poolOptions);
    }
}
