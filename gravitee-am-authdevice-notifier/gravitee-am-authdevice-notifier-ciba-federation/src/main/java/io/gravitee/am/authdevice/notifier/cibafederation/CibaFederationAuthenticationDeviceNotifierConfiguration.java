...
public class CibaFederationAuthenticationDeviceNotifierConfiguration implements AuthenticationDeviceNotifierConfiguration {
    ...
    // is configured (non-blank) — this is the provider's (e.g. Auth0) resource-indicator parameter
    ...
    private String consentRelayStrategy = "auth0-user-profile"; // or "passthrough"
