 ...
 */
package io.gravitee.repository.ratelimit.test.config;
...
@Configuration
@ComponentScan({"io.gravitee.repository.ratelimit", "io.gravitee.am.repository.mongodb.common", "io.gravitee.am.repository.mongodb.provider"})
