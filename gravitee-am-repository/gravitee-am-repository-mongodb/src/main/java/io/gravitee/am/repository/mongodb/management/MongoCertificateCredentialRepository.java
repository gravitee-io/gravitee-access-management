...
import io.gravitee.am.repository.mongodb.management.internal.model.CertificateCredentialMongo;
...
public class MongoCertificateCredentialRepository extends AbstractManagementMongoRepository implements CertificateCredentialRepository {
    ...
    @PostConstruct
    public void init() {
        certificateCredentialsCollection = mongoOperations.getCollection(COLLECTION_NAME, CertificateCredentialMongo.class);
        super.init(certificateCredentialsCollection);
