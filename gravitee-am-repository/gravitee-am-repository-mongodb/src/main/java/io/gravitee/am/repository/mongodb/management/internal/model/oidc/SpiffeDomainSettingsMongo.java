...
public class SpiffeDomainSettingsMongo {
    ...
    public List<String> getDefaultAllowedAlgorithms() { return defaultAllowedAlgorithms; }
    public void setDefaultAllowedAlgorithms(List<String> defaultAllowedAlgorithms) { this.defaultAllowedAlgorithms = defaultAllowedAlgorithms; }
}
