...
public class MongoEmailStagingRepository extends AbstractGatewayMongoRepository implements EmailStagingRepository {
    ...
    private static final String COLLECTION_NAME = "email_staging";
    ...
    @Override
    public Flowable<EmailStaging> findOldestByUpdateDate(int limit) {
        return Observable.fromPublisher(
                withMaxTime(emailStagingCollection.find()
