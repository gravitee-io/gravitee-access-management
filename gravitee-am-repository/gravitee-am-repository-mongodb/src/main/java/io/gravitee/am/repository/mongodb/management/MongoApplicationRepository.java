...
public class MongoApplicationRepository extends AbstractManagementMongoRepository implements ApplicationRepository {
    ...
    public Flowable<Application> findAll() {
        return Flowable.fromPublisher(applicationsCollection.find().sort(new BasicDBObject(FIELD_UPDATED_AT, -1)))
    ...
    public Single<Page<Application>> findAll(int page, int size) {
        ...
        Single<List<Application>> applicationsOperation = Observable.fromPublisher(withMaxTime(applicationsCollection.find())
    ...
    public Single<Page<Application>> search(String domain, List<String> applicationIds, String query, ApplicationType type, int page, int size) {
        ...
        Single<List<Application>> applicationsOperation = Observable.fromPublisher(findPublisher)
                .map(MongoApplicationRepository::convert)
                .collect(ArrayList::new, List::add);
    ...
    private List<Bson> buildCriteriaFilters(ApplicationCriteria criteria) {
        ...
        criteria.getTypes().ifPresent(types -> filters.add(in(FIELD_TYPE, types.stream().map(Enum::name).toList())));
        return filters;
    }
    ...
    private static ApplicationOAuthSettingsMongo convert(ApplicationOAuthSettings other) {
        ...
        applicationOAuthSettingsMongo.setCommandEndpoint(other.getCommandEndpoint());
    ...
    private static ApplicationOAuthSettings convert(ApplicationOAuthSettingsMongo other) {
        ...
        applicationOAuthSettings.setCommandEndpoint(other.getCommandEndpoint());
