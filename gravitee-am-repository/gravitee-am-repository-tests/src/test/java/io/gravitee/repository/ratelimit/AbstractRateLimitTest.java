...
import io.gravitee.repository.ratelimit.test.config.RateLimitTestConfigurationLoader;
...
@ContextConfiguration(classes = {RateLimitTestConfigurationLoader.class}, loader = AnnotationConfigContextLoader.class)
