...
public class EmailStagingRepositoryTest extends AbstractGatewayTest {
    ...
    public void shouldFindOldestByUpdateDate() throws InterruptedException {
        ...
        TestSubscriber<EmailStaging> observer = repository.findOldestByUpdateDate(2).test();
        observer.awaitDone(10, TimeUnit.SECONDS);
    ...
    public void shouldFindOldestByUpdateDateWithLimit() throws InterruptedException {
        ...
        TestSubscriber<EmailStaging> observer = repository.findOldestByUpdateDate(3).test();
        observer.awaitDone(10, TimeUnit.SECONDS);
    ...
    private EmailStaging createEmailStaging() {
        ...
        emailStaging.setReferenceId("domain-id-" + random);
