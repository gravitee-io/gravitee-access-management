 ...
 */
package io.gravitee.am.repository.gateway;

import io.gravitee.am.repository.RepositoriesTestInitializer;
import io.gravitee.am.repository.gateway.test.config.GatewayTestConfigurationLoader;
...
@ContextConfiguration(classes = {GatewayTestConfigurationLoader.class},
