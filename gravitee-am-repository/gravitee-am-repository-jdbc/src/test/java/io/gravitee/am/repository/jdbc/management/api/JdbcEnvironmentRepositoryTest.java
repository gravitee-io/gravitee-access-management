 ...
 */
public class JdbcEnvironmentRepositoryTest extends AbstractManagementJdbcTest {
    ...
    public void testDelete() {
        ...
        assertFalse(domainRestrictionRepository.findAllByEnvironmentId(envCreated.getId()).blockingIterable().iterator().hasNext());
    }
}
