 ...
 */
public class JdbcEventRepositoryTest extends AbstractManagementJdbcTest {
    ...
    public void testFindById() throws TechnicalException {
        ...
        Event event = new Event();
        event.setType(Type.DOMAIN);
        event.setPayload(new Payload("pid", ReferenceType.ORGANIZATION, "oid", Action.BULK_CREATE));
        ...
        testObserver.assertValue(e -> e.getPayload().values().containsAll(event.getPayload().values()));
    }
    ...
    public void testCreate() throws TechnicalException {
        ...
        Event event = new Event();
        event.setType(Type.DOMAIN);
        event.setPayload(new Payload(new HashMap<>()));
