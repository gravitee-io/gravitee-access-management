...
/*
 * NOTE : Duplicate this class to allow multiple instance of ConstantPool object.
 *        Otherwise PERSITENT_CHANNEL & CONNECTION initialization will throw exception if R3DBC is used in multiple plugins
 */
...
public final class ReactorNetty {
    ...
    // [GIO] change the name of these two AttributeKey to allow multiple plugin types using reactor-netty
    static final AttributeKey<Boolean> PERSISTENT_CHANNEL = AttributeKey.newInstance("$PERSISTENT_CHANNEL_REPOSITORY");

    static final AttributeKey<Connection> CONNECTION = AttributeKey.newInstance("$CONNECTION_REPOSITORY");
