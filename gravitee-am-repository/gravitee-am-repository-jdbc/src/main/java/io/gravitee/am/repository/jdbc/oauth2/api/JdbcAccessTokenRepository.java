...
public class JdbcAccessTokenRepository extends AbstractJdbcRepository implements AccessTokenRepository {
    ...
    public Maybe<AccessToken> findByToken(String token) {
        ...
        return accessTokenRepository.findByToken(token, LocalDateTime.now())
                .map(this::toEntity)
    ...
    public Observable<AccessToken> findByClientIdAndSubject(String clientId, String subject) {
        ...
        return accessTokenRepository.findByClientIdAndSubject(clientId, subject, LocalDateTime.now())
                .map(this::toEntity)
                .toObservable()
    ...
    public Observable<AccessToken> findByClientId(String clientId) {
        ...
        return accessTokenRepository.findByClientId(clientId, LocalDateTime.now())
                .map(this::toEntity)
                .toObservable()
    ...
    public Observable<AccessToken> findByAuthorizationCode(String authorizationCode) {
        ...
        return accessTokenRepository.findByAuthorizationCode(authorizationCode, LocalDateTime.now())
                .map(this::toEntity)
                .toObservable()
    ...
    public Single<Long> countByClientId(String clientId) {
        return accessTokenRepository.countByClientId(clientId, LocalDateTime.now());
    }
