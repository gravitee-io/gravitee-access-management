...
public class PatchSpiffeDomainSettings {
    ...
    @Schema(description = "Deprecated: moved to oidc.keyRetrievalSettings.allowUnsecuredHttpUri.", deprecated = true)
    @Deprecated
    private Optional<Boolean> allowUnsecuredHttpUri;
    @Schema(description = "Deprecated: moved to oidc.keyRetrievalSettings.allowPrivateIpAddress.", deprecated = true)
    @Deprecated
    private Optional<Boolean> allowPrivateIpAddress;
    @Schema(description = "Deprecated: moved to oidc.keyRetrievalSettings.fetchTimeoutMs.", deprecated = true)
    @Deprecated
    private Optional<Integer> fetchTimeoutMs;
    @Schema(description = "Deprecated: moved to oidc.keyRetrievalSettings.maxResponseSizeKb.", deprecated = true)
    @Deprecated
    private Optional<Integer> maxResponseSizeKb;
    @Schema(description = "Deprecated: moved to oidc.keyRetrievalSettings.cacheTtlSeconds.", deprecated = true)
    @Deprecated
    private Optional<Integer> cacheTtlSeconds;
    @Schema(description = "Deprecated: moved to oidc.keyRetrievalSettings.cacheMaxEntries.", deprecated = true)
    @Deprecated
