...
public class PatchLoginSettings {
    ...
    public Optional<Boolean> getCertificateBasedAuthEnabled() {
        return certificateBasedAuthEnabled;
    }

    public void setCertificateBasedAuthEnabled(Optional<Boolean> certificateBasedAuthEnabled) {
        this.certificateBasedAuthEnabled = certificateBasedAuthEnabled;
    }

    public Optional<String> getCertificateBasedAuthUrl() {
        return certificateBasedAuthUrl;
    }

    public void setCertificateBasedAuthUrl(Optional<String> certificateBasedAuthUrl) {
