 ...
 */
public class MaxLengthPasswordValidator implements PasswordValidator {

    private static final String ERROR_MESSAGE = "invalid password maximum length";
    ...
    public MaxLengthPasswordValidator(Integer maxLength) {
