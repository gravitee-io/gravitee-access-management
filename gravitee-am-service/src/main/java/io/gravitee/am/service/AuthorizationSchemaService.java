...
public interface AuthorizationSchemaService {
    ...
    Maybe<AuthorizationSchema> findByDomain(String domainId);

    Maybe<AuthorizationSchema> findById(String id);

    Single<AuthorizationSchema> createOrUpdate(Domain domain, UpdateAuthorizationSchema request, User principal);
    ...
    Flowable<AuthorizationSchemaVersion> getVersionHistory(String domainId);

    Single<AuthorizationSchema> rollback(Domain domain, int targetVersion, User principal);
}
