 ...
 */
public interface CimdMetadataDocumentService {
    ...
    /**
     * Persists (creates or replaces) a fetched metadata document for the given domain and clientId,
     * then publishes a sync event so other gateway instances can invalidate their local caches.
     */
