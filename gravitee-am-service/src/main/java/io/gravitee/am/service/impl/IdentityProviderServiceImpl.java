...
public class IdentityProviderServiceImpl implements IdentityProviderService {
        ...
        return identityProviderRepository
            ...
            .onErrorResumeNext(
                ex -> {
                    ...
                    return Single.error(
                        new TechnicalManagementException("An error occurs while trying to find all identity providers", ex)
                    );
                }
            );
    }
                ...
                ex -> {
                    ...
                    return Maybe.error(
                        new TechnicalManagementException(
                            String.format("An error occurs while trying to find an identity provider using its ID: %s", id),
                            ex
                        )
                    );
                }
        ...
        return identityProviderRepository
            ...
            .onErrorResumeNext(
                ex -> {
                    ...
                    return Single.error(
                        new TechnicalManagementException(
                            "An error occurs while trying to find identity providers by " + referenceType.name(),
                            ex
                        )
                    );
                }
    ...
    @Override
    public Single<IdentityProvider> create(
        ...
        return identityProviderRepository
            ...
            .flatMap(
                identityProvider1 -> {
                    ...
                    Event event = new Event(
                        ...
                        new Payload(
                            identityProvider1.getId(),
                            identityProvider1.getReferenceType(),
                            identityProvider1.getReferenceId(),
                            Action.CREATE
                        )
                    );
            ...
            .doOnSuccess(
                identityProvider1 ->
                    auditService.report(
                        AuditBuilder
                            .builder(IdentityProviderAuditBuilder.class)
                            .principal(principal)
                            .type(EventType.IDENTITY_PROVIDER_CREATED)
    ...
    @Override
    public Single<IdentityProvider> update(
        ReferenceType referenceType,
        String referenceId,
        String id,
        ...
        return identityProviderRepository
            ...
            .onErrorResumeNext(
                ex -> {
                    ...
                    return Single.error(
                        new TechnicalManagementException("An error occurs while trying to update an identity provider", ex)
                    );
                }
            );
    }
    ...
    public Completable delete(ReferenceType referenceType, String referenceId, String identityProviderId, User principal) {
        ...
        return identityProviderRepository
            .findById(referenceType, referenceId, identityProviderId)
            .switchIfEmpty(Maybe.error(new IdentityProviderNotFoundException(identityProviderId)))
            .flatMapSingle(
                identityProvider ->
                    applicationService
                        .findByIdentityProvider(identityProviderId)
                        .flatMap(
                            applications -> {
            ...
            .flatMapCompletable(
                identityProvider -> {
                    ...
                    Event event = new Event(
                        Type.IDENTITY_PROVIDER,
                        new Payload(identityProviderId, referenceType, referenceId, Action.DELETE)
                    );
                            ...
                            () ->
                                auditService.report(
                                    AuditBuilder
                                        .builder(IdentityProviderAuditBuilder.class)
                                        .principal(principal)
                                        .type(EventType.IDENTITY_PROVIDER_DELETED)
            ...
            .onErrorResumeNext(
                ex -> {
                    ...
                    return Completable.error(
                        new TechnicalManagementException(
                            String.format("An error occurs while trying to delete identity provider: %s", identityProviderId),
                            ex
                        )
                    );
                }
