...
import static io.gravitee.am.service.reporter.SystemReporterConfigResolver.SYSTEM_ONLY_TYPES;
...
public class ReporterServiceImpl implements ReporterService {
    ...
    public Single<Reporter> createSystem(Reference reference, String id, String automationKey, User principal) {
        ...
        if (base == null) {
            return Single.error(new ReporterNotFoundException("Reporter type " + systemReporterConfigResolver.reporterType() + " not found"));
        }
