...
public class PatchApplicationOAuthSettings {
    ...
    private Optional<Boolean> asyncTokenStore;
    ...
    public Optional<Boolean> getAsyncTokenStore() {
        return asyncTokenStore;
    }

    public void setAsyncTokenStore(Optional<Boolean> asyncTokenStore) {
    ...
    public ApplicationOAuthSettings patch(ApplicationOAuthSettings _toPatch) {
        ...
        SetterUtils.safeSet(toPatch::setAsyncTokenStore, this.getAsyncTokenStore());
