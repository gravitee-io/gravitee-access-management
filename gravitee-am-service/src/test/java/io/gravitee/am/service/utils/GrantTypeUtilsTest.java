...
public class GrantTypeUtilsTest {
    ...
    public void isSupportedGrantType_empty_grant_type() {
        ...
        assertFalse(isSupportedGrantType);
    }

    @Test
    public void supportedGrantTypes() {
        assertTrue(GrantTypeUtils.getSupportedGrantTypes().contains("authorization_code"));
    }
    ...
    public void completeGrantTypeCorrespondance_missingImplicitGrantType() {
        ...
        application = GrantTypeUtils.completeGrantTypeCorrespondance(application);
        assertTrue(application.getSettings().getOauth().getGrantTypes().contains("implicit"));
        assertFalse(application.getSettings().getOauth().getGrantTypes().contains("authorization_code"));
    }
    ...
    public void completeGrantTypeCorrespondance_removeImplicitGrantType() {
        ...
        application = GrantTypeUtils.completeGrantTypeCorrespondance(application);
        assertFalse(application.getSettings().getOauth().getGrantTypes().contains("implicit"));
        assertTrue(application.getSettings().getOauth().getGrantTypes().contains("authorization_code"));
    }
    ...
    public void completeGrantTypeCorrespondance_caseNoResponseType() {
        ...
        assertTrue(application.getSettings().getOauth().getGrantTypes().contains("client_credentials"));
    }
    ...
    public void completeGrantTypeCorrespondance_caseAllEmpty() {
        ...
        application = GrantTypeUtils.completeGrantTypeCorrespondance(application);
        assertTrue(application.getSettings().getOauth().getResponseTypes().contains("code"));
        assertTrue(application.getSettings().getOauth().getGrantTypes().contains("authorization_code"));
    }
}
