...
public class ApplicationSecretServiceTest {
    ...
    public void shouldRenewSecret() {
        ...
        testObserver.assertComplete();
        testObserver.assertNoErrors();
        testObserver.assertValue(app -> app.getSecrets().stream().anyMatch(s->s.getSecret().equals("secret123")));
    ...
    public void shouldRenew_withNewSecretSettings() {
        ...
        testObserver.assertComplete();
        testObserver.assertNoErrors();
        testObserver.assertValue(app -> app.getSecrets().stream().anyMatch(s->s.getSecret().equals("secret123") && s.getSettingsId().equals("settings-id")));
