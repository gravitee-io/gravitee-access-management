...
public class PasswordPolicyServiceTest {
    ...
    @InjectMocks
    private PasswordPolicyServiceImpl passwordPolicyService = new PasswordPolicyServiceImpl();
    ...
    public void shouldFindByDomain(){
        ...
        TestSubscriber<PasswordPolicy> testObserver = passwordPolicyService.findByDomain("domain").test();
