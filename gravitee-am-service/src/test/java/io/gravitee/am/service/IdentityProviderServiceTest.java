...
public class IdentityProviderServiceTest {
    ...
    @Test
    public void shouldCreate_keepTheIdSuppliedByTheAutomationApi() {
        AutomationNewIdentityProvider newIdentityProvider = new AutomationNewIdentityProvider();
        newIdentityProvider.setId("idp-domain-1-dev-users");
    ...
    @Test
    public void shouldCreate_keepTheIdFromRequestBodyWhenThePlatformDoesNotOwnStorage() {
        NewIdentityProvider newIdentityProvider = new NewIdentityProvider();
        newIdentityProvider.setId("an-id-i-chose");
        newIdentityProvider.setType("inline-am-idp");
        newIdentityProvider.setName("my-idp");
        newIdentityProvider.setConfiguration("{}");
        ...
        testObserver.assertComplete();
        verify(identityProviderRepository).create(captor.capture());
        Assert.assertEquals("an-id-i-chose", captor.getValue().getId());
    }
