...
public class Bootstrap {
    ...
    private static final String CONTAINER_CLASS = "io.gravitee.am.gateway.container.GatewayContainer";
    ...
    private void checkInstallRoot(File graviteeHomeDir) {
        ...
        File[] files = graviteeLibDir.listFiles(pathname -> pathname.getName().startsWith("gravitee-am-gateway-standalone-bootstrap"));
