...
public class Container {
    ...
    private void initializeContext() {
        LoggerFactory.getLogger(Container.class).info("Initializing Gravitee.io AM Gateway context...");
     ...
     */
    public void start() {
        LoggerFactory.getLogger(Container.class).info("Start Gravitee.io AM Gateway...");
        ...
        try {
            ...
            LoggerFactory.getLogger(Container.class).error("An unexpected error occurs while starting Gravitee.io AM Gateway", ex);
            stop();
        }
    }
    ...
    public void stop() {
        if (! stopped) {
            LoggerFactory.getLogger(Container.class).info("Shutting-down Gravitee.io AM Gateway...");
