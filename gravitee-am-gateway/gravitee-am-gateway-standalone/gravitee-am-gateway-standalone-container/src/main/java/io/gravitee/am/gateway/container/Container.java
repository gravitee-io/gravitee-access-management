...
import io.gravitee.am.gateway.spring.PropertiesConfiguration;
...
public class Container {
    ...
    private void initializeContext() {
        LoggerFactory.getLogger(Container.class).info("Initializing Gravitee.io Access Management Gateway context...");
     ...
     */
    public void start() {
        LoggerFactory.getLogger(Container.class).info("Start Gravitee.io Access Management Gateway...");
        ...
        try {
            ...
            LoggerFactory.getLogger(Container.class).error("An unexpected error occurs while starting Gravitee.io Access Management Gateway", ex);
            stop();
        }
    }
    ...
    public void stop() {
        if (! stopped) {
            LoggerFactory.getLogger(Container.class).info("Shutting-down Gravitee.io Access Management Gateway...");
