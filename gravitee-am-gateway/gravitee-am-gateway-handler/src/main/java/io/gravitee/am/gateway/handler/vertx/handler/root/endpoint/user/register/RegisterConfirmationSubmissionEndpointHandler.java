 ...
 */
public class RegisterConfirmationSubmissionEndpointHandler extends UserRequestHandler {

    private static final String passwordParam = "password";

    private UserService userService;

    public RegisterConfirmationSubmissionEndpointHandler(UserService userService) {
