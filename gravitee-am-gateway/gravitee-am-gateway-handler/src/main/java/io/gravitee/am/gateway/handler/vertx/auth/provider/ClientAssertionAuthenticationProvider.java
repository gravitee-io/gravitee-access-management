...
public class ClientAssertionAuthenticationProvider implements AuthProvider {
    ...
    public void authenticate(JsonObject jsonObject, Handler<AsyncResult<User>> handler) {
        String clientAssertionType = jsonObject.getString(OIDCParameters.CLIENT_ASSERTION_TYPE);
        String clientAssertion = jsonObject.getString(OIDCParameters.CLIENT_ASSERTION);
        String clientId = jsonObject.getString(OAuth2Constants.CLIENT_ID);
