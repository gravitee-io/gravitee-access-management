 ...
 */
package io.gravitee.am.gateway.handler.vertx.handler.cookie;
 ...
 */
public class CookieHandler implements io.vertx.ext.web.handler.CookieHandler {
    ...
    public static io.vertx.reactivex.ext.web.handler.CookieHandler create() {
        return io.vertx.reactivex.ext.web.handler.CookieHandler.newInstance(new CookieHandler());
    }
}
