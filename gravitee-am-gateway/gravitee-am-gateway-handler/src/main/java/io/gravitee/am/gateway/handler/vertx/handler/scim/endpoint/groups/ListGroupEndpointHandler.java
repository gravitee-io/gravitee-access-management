 ...
 */
public class ListGroupEndpointHandler implements Handler<RoutingContext> {

    private static final Logger logger = LoggerFactory.getLogger(ListGroupEndpointHandler.class);
