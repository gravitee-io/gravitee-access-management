 ...
 */
public class UpdateGroupEndpointHandler implements Handler<RoutingContext> {

    private static final Logger logger = LoggerFactory.getLogger(UpdateGroupEndpointHandler.class);
