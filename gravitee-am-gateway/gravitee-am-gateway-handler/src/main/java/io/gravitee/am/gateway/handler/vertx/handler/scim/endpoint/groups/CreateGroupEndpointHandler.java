 ...
 */
public class CreateGroupEndpointHandler implements Handler<RoutingContext> {

    private static final Logger logger = LoggerFactory.getLogger(CreateGroupEndpointHandler.class);
