...
public class HybridResponse extends ImplicitResponse {
    ...
    @Override
    public String buildRedirectUri(AuthorizationRequest authorizationRequest) throws URISyntaxException {
        ...
        if (io.gravitee.am.common.oidc.ResponseType.CODE_ID_TOKEN.equals(authorizationRequest.getResponseType())) {
