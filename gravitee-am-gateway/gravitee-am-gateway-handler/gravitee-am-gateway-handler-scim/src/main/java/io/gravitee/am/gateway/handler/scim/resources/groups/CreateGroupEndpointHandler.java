...
/**
 * To router new resources, clients send HTTP POST requests to the resource endpoint, such as "/Groups".
 *
 ...
 */
public class CreateGroupEndpointHandler extends AbstractGroupEndpointHandler {

    private GroupService groupService;
    private ObjectMapper objectMapper;

    public CreateGroupEndpointHandler(GroupService groupService) {
    ...
    public static CreateGroupEndpointHandler create(GroupService groupService) {
        return new CreateGroupEndpointHandler(groupService);
    }
}
