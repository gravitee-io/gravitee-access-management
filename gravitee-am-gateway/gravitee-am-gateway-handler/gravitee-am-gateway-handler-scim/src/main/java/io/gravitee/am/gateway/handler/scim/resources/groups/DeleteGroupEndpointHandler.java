 ...
 */
public class DeleteGroupEndpointHandler implements Handler<RoutingContext> {

    private GroupService groupService;

    public DeleteGroupEndpointHandler(GroupService groupService) {
    ...
    public static DeleteGroupEndpointHandler create(GroupService groupService) {
        return new DeleteGroupEndpointHandler(groupService);
    }
}
