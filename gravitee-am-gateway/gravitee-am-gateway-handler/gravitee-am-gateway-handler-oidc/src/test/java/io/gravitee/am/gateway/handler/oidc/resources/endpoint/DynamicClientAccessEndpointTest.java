...
public class DynamicClientAccessEndpointTest extends RxWebTestBase {
    ...
    public void read() throws Exception {
        testRequest(HttpMethod.GET, "/register/my-test-client_id", HttpStatusCode.OK_200, "OK");
    }

    @Test
    public void read_notFound() throws Exception {
        testRequest(HttpMethod.GET, "/register/unknown", HttpStatusCode.NOT_FOUND_404, "Not Found");
    }
    ...
    public void delete() throws Exception {
        ...
        testRequest(HttpMethod.DELETE, "/register/my-test-client_id", HttpStatusCode.NO_CONTENT_204, "No Content");
    }

    @Test
    public void delete_notFound() throws Exception {
        testRequest(HttpMethod.DELETE, "/register/unknown", HttpStatusCode.NOT_FOUND_404, "Not Found");
    }
    ...
    public void renewClientSecret() throws Exception {
        ...
        testRequest(HttpMethod.POST, "/register/my-test-client_id/renew_secret", HttpStatusCode.OK_200, "OK");
    }

    @Test
    public void renewClientSecret_notFound() throws Exception {
        testRequest(HttpMethod.POST, "/register/unknown/renew_secret", HttpStatusCode.NOT_FOUND_404, "Not Found");
    }

    @Test
    public void patch_noBody() throws Exception {
        String body = "{\"redirect_uris\": [\"https://redirecturi\"]}";
        testRequest(HttpMethod.PATCH, "/register/my-test-client_id", HttpStatusCode.BAD_REQUEST_400, "Bad Request");
    }

    @Test
    public void update_noBody() throws Exception {
        String body = "{\"redirect_uris\": [\"https://redirecturi\"]}";
        testRequest(HttpMethod.PUT, "/register/my-test-client_id", HttpStatusCode.BAD_REQUEST_400, "Bad Request");
    }
