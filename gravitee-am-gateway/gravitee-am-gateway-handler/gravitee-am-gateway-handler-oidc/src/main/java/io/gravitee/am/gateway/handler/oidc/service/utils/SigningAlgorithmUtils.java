...
public class SigningAlgorithmUtils {
    ...
    private static final Set<String> SUPPORTED_USERINFO_SIGNING_ALG = new HashSet<>(Arrays.asList(
            JWSAlgorithm.RS256.getName(), JWSAlgorithm.RS384.getName(), JWSAlgorithm.RS512.getName()
    ));

    private static final Set<String> SUPPORTED_ID_TOKEN_SIGNING_ALG = new HashSet<>(Arrays.asList(
