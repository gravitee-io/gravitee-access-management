...
public final class ClaimsRequestResolver {
     ...
     */
    private Map<String, ClaimRequest> resolveClaimsRequest(JsonObject claimsRequest, String parameterName) {
        JsonObject claimsParameterValue = claimsRequest.getJsonObject(parameterName);
        if (claimsParameterValue != null) {
            Map<String, ClaimRequest> claimsParameter = new HashMap<>();
     ...
     */
    private void resolveIndividualClaimsRequests(String claimName, Object claimValue, Map<String, ClaimRequest> claimsParameter) {
