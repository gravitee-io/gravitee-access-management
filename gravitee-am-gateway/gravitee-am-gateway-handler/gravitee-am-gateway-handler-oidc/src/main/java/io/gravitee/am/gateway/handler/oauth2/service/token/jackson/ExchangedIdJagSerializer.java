...
import io.gravitee.am.gateway.handler.oauth2.service.token.impl.ExchangedIdJag;

import java.io.IOException;

public class ExchangedIdJagSerializer extends StdSerializer<ExchangedIdJag> {

    public ExchangedIdJagSerializer() {
        super(ExchangedIdJag.class);
    }

    @Override
    public void serialize(ExchangedIdJag token, JsonGenerator jsonGenerator, SerializerProvider provider) throws IOException {
