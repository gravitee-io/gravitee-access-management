...
public interface UserService {
    ...
    /**
     * Verify token generated by AM to authorize async actions like to reset a password using a link received by email and identify a user
     * In those cases, the 'sub' claim contains the userId.
     *
     * @param token
     * @return
     */
