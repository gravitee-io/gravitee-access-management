...
public class RootProvider extends AbstractProtocolProvider {
    ...
    private void authFlowContextHandler(Router router) {
        ...
        router.route(GET, PATH_LOGIN).handler(transactionIdHandler).handler(authenticationFlowContextHandler);
        ...
        // WebAuthn endpoint
        router.route(GET, PATH_WEBAUTHN_REGISTER).handler(transactionIdHandler).handler(authenticationFlowContextHandler);
        ...
        router.route(GET, PATH_WEBAUTHN_LOGIN).handler(transactionIdHandler).handler(authenticationFlowContextHandler);
        router.route(PATH_WEBAUTHN_LOGIN).handler(authenticationFlowContextHandler);

        // Identifier First Login endpoint
        router.route(GET, PATH_IDENTIFIER_FIRST_LOGIN).handler(transactionIdHandler).handler(authenticationFlowContextHandler);
