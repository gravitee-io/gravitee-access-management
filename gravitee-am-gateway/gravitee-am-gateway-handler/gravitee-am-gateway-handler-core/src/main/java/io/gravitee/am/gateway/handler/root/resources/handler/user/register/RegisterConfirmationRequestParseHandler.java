 ...
 */
public class RegisterConfirmationRequestParseHandler extends UserTokenRequestParseHandler {

    public RegisterConfirmationRequestParseHandler(UserService userService) {
        super(userService);
    }
}
