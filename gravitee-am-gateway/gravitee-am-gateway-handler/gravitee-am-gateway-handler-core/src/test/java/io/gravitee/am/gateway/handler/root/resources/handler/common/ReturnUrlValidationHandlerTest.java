...
public class ReturnUrlValidationHandlerTest {
    ...
    private final String gatewayUrl = "https://gateway.com";
    @Test
    public void when_return_url_is_not_present_let_it_pass(){
        Domain domain = new Domain();
        ReturnUrlValidationHandler handler = new ReturnUrlValidationHandler(domain, gatewayUrl);
    ...
    @Test
    public void when_return_url_is_present_and_it_matches_gateway_url_validate_it(){
        Domain domain = new Domain();
        ReturnUrlValidationHandler handler = new ReturnUrlValidationHandler(domain, gatewayUrl);
        ...
        HttpServerRequest request = Mockito.mock();
        Mockito.when(ctx.request()).thenReturn(request);
        Mockito.when(request.getParam("return_url")).thenReturn(gatewayUrl);
