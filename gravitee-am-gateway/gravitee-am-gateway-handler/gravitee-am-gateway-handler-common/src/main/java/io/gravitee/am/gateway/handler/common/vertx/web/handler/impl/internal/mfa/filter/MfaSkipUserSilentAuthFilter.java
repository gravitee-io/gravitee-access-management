 ...
 */
public class MfaSkipUserSilentAuthFilter extends MfaContextHolder implements Supplier<Boolean> {

    public MfaSkipUserSilentAuthFilter(MfaFilterContext context) {
        super(context);
    }

    @Override
    public Boolean get() {
        return context.isUserSilentAuth();
    }
}
