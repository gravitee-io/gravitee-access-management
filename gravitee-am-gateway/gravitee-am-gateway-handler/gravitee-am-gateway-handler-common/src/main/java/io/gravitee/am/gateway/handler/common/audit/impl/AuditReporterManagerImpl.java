 ...
 */
public class AuditReporterManagerImpl
    extends AbstractService
    implements AuditReporterManager, EventListener<ReporterEvent, Payload>, InitializingBean {
    ...
    private void startReporterProvider(Reporter reporter) {
        ...
        io.gravitee.am.reporter.api.provider.Reporter reporterProvider = reporterPluginManager.create(
            reporter.getType(),
        ...
        if (reporterProvider != null) {
            try {
                ...
                io.gravitee.am.reporter.api.provider.Reporter eventBusReporter = new EventBusReporterWrapper(
                    vertx,
                    domain.getId(),
                    reporterProvider
                );
