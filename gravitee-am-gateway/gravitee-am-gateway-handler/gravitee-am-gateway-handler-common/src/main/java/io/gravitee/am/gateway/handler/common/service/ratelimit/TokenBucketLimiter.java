...
/**
 * The token bucket every rate limited feature shares: tokens refill over the configured time
 * period, one is spent per request, and a request finding an empty bucket is refused.
 *
