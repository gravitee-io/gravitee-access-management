...
public class RedirectHandlerImpl implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext context) {
        ...
        try {
            ...
            if (queryParams.contains(io.gravitee.am.common.oidc.Parameters.LOGIN_HINT)) {
                ...
                final String login_hint = queryParams.get(io.gravitee.am.common.oidc.Parameters.LOGIN_HINT);
                if (!UriBuilder.decodeURIComponent(login_hint).equals(login_hint)
                        && login_hint.contains("@")
                        && login_hint.contains("+")) {
                    queryParams.set(io.gravitee.am.common.oidc.Parameters.LOGIN_HINT, UriBuilder.encodeURIComponent(login_hint));
                }
            }
